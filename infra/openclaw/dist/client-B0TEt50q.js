import { Yt as resolveStateDir } from "./entry.js";
import { a as logError, i as logDebug } from "./exec-CBKBIMpA.js";
import { h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES, p as GATEWAY_CLIENT_IDS } from "./message-channel-B9mgJ1nn.js";
import { p as rawDataToString } from "./net-DsmdySgI.js";
import { t as INPUT_PROVENANCE_KIND_VALUES } from "./input-provenance-BPpmKfDN.js";
...
var GatewayClient = class {
	...
	start() {
		...
		this.ws.on("close", (code, reason) => {
			...
			this.ws = null;
			if (code === 1008 && reasonText.toLowerCase().includes("device token mismatch") && this.opts.deviceIdentity) {
