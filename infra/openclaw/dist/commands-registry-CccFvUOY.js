...
import { s as getActivePluginRegistry, w as escapeRegExp } from "./registry-DykAc8X1.js";
import { Q as DEFAULT_PROVIDER, Z as DEFAULT_MODEL, u as resolveConfiguredModelRef } from "./model-selection-CAfIlaZ9.js";
import { f as listChannelDocks, r as listThinkingLevels } from "./thinking-C6NjWV99.js";
...
const formatConfigArgs = (values) => {
	...
	if (!action) return;
	const rest = formatSetUnsetArgAction(action, {
		path,
		value
	});
