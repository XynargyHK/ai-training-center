...
import { X as resolvePreferredOpenClawTmpDir } from "./utils-CFnnyoTP.js";
import { i as loadConfig } from "./config-F0Q6PyfW.js";
import { h as maxBytesForKind, s as extensionForMime } from "./image-ops-ib1_UDIa.js";
import { h as normalizeDiscordToken, m as resolveDiscordAccount } from "./normalize-C23emibo.js";
import { a as requireTargetKind, i as parseTargetPrefixes, n as ensureTargetId, r as parseTargetMention, t as buildMessagingTarget } from "./targets-nBKd2EZf.js";
import { n as retryAsync, t as resolveRetryConfig } from "./retry-CsJdgSl0.js";
import { c as resolveChunkMode, i as chunkMarkdownTextWithMode } from "./chunk-DcqcJHjP.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-CQQzFscn.js";
import { a as loadWebMedia, o as loadWebMediaRaw } from "./ir-CPmg2HMv.js";
import { n as normalizePollInput, t as normalizePollDurationHours } from "./polls-BNW64Izx.js";
import { n as recordChannelActivity, r as createDiscordRetryRunner } from "./channel-activity-4gYIj57z.js";
import { t as resolveFetch } from "./fetch-D_cxmFbk.js";
import { t as convertMarkdownTables } from "./tables-BJY31-CG.js";
	...
	if (isForumLikeType(channelType)) {
		...
		try {
			if (opts.mediaUrl) {
				...
				for (const chunk of afterMediaChunks) await sendDiscordText(rest, threadId, chunk, void 0, request, accountInfo.config.maxLinesPerMessage, void 0, void 0, chunkMode, opts.silent);
			} else for (const chunk of remainingChunks) await sendDiscordText(rest, threadId, chunk, void 0, request, accountInfo.config.maxLinesPerMessage, void 0, void 0, chunkMode, opts.silent);
		} catch (err) {
			throw await buildDiscordSendError(err, {
				channelId: threadId,
				rest,
...
//#endregion
export { resolveDiscordChannelId as $, addRoleDiscord as A, removeRoleDiscord as B, fetchMessageDiscord as C, buildChannelKeyCandidates as Ct, readMessagesDiscord as D, pinMessageDiscord as E, fetchRoleInfoDiscord as F, createChannelDiscord as G, listGuildEmojisDiscord as H, fetchVoiceStatusDiscord as I, moveChannelDiscord as J, deleteChannelDiscord as K, kickMemberDiscord as L, createScheduledEventDiscord as M, fetchChannelInfoDiscord as N, searchMessagesDiscord as O, fetchMemberInfoDiscord as P, parseDiscordTarget as Q, listGuildChannelsDiscord as R, editMessageDiscord as S, applyChannelMatchMeta as St, listThreadsDiscord as T, uploadEmojiDiscord as U, timeoutMemberDiscord as V, uploadStickerDiscord as W, setChannelPermissionDiscord as X, removeChannelPermissionDiscord as Y, stripUndefinedFields as Z, sendPollDiscord as _, resolveTimestampMs as _t, removeReactionDiscord as a, normalizeDiscordSlug as at, createThreadDiscord as b, createDiscordClient as bt, formatDiscordComponentEventText as c, resolveDiscordGuildEntry as ct, parseDiscordModalCustomId as d, resolveDiscordShouldRequireMention as dt, listDiscordDirectoryGroupsLive as et, parseDiscordModalCustomIdForCarbon as f, resolveGroupDmAllow as ft, sendMessageDiscord as g, resolveDiscordSystemLocation as gt, resolveDiscordModalEntry as h, formatDiscordUserTag as ht, removeOwnReactionsDiscord as i, normalizeDiscordAllowList as it, banMemberDiscord as j, unpinMessageDiscord as k, parseDiscordComponentCustomId as l, resolveDiscordMemberAccessState as lt, resolveDiscordComponentEntry as m, formatDiscordReactionEmoji as mt, fetchReactionsDiscord as n, allowListMatches as nt, sendDiscordComponentMessage as o, resolveDiscordAllowListMatch as ot, readDiscordComponentSpec as p, shouldEmitDiscordReactionNotification as pt, editChannelDiscord as q, reactMessageDiscord as r, isDiscordGroupAllowedByPolicy as rt, createDiscordFormModal as s, resolveDiscordChannelConfigWithFallback as st, send_exports as t, listDiscordDirectoryPeersLive as tt, parseDiscordComponentCustomIdForCarbon as u, resolveDiscordOwnerAllowFrom as ut, sendStickerDiscord as v, fetchDiscord as vt, listPinsDiscord as w, resolveChannelEntryMatchWithFallback as wt, deleteMessageDiscord as x, chunkDiscordTextWithMode as xt, sendVoiceMessageDiscord as y, fetchChannelPermissionsDiscord as yt, listScheduledEventsDiscord as z };