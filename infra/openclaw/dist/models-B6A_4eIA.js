...
import { Dt as theme, Et as isRich$1, Pt as CONFIG_PATH, Tt as colorize, ut as shortenHomePath } from "./entry.js";
import { Bt as DEFAULT_PROVIDER, F as modelKey, H as resolveDefaultModelForAgent, L as normalizeProviderId, M as findNormalizedProviderValue, R as parseModelRef, T as resolveOpenClawAgentDir, V as resolveConfiguredModelRef, Vt as resolveAuthProfileDisplayLabel, W as resolveModelRefFromString, _ as setAuthProfileOrder, b as ensureAuthProfileStore, bt as resolveEnvApiKey, gt as getCustomProviderApiKey, h as listProfilesForProvider, j as buildModelAliasIndex, kt as shouldEnableShellEnvFallback, n as resolveAuthProfileOrder, s as resolveProfileUnusableUntilForDisplay, v as upsertAuthProfile, vt as resolveApiKeyForProvider, w as resolveAuthStorePathForDisplay, wt as getShellEnvAppliedKeys, yt as resolveAwsSdkEnvVarName, zt as DEFAULT_MODEL } from "./auth-profiles-Cn5oo5Dj.js";
import { t as formatCliCommand } from "./command-format-Cutkv9UT.js";
import { E as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelPrimary, c as resolveDefaultAgentId, i as resolveAgentModelFallbacksOverride, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-F21xRiu_.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./pi-auth-json-BrT0mGxa.js";
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-CAOd95Vl.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-Do3xMEtM.js";
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-CQx0LPGX.js";
import { Gt as formatUsageWindowSummary, Kt as resolveUsageProviderId, Ut as loadProviderUsageSummary, nt as describeFailoverError, s as runEmbeddedPiAgent } from "./subagent-registry-DN6TUJw4.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CJeHSIux.js";
import { t as ensureOpenClawModelsJson } from "./models-config-QXP5sEUp.js";
import { n as loadModelCatalog } from "./model-catalog-d5K0907t.js";
import { r as withProgressTotals } from "./progress-Clpi3Ckj.js";
import { f as openUrl } from "./onboard-helpers-Wi2a0F-c.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-B_yUCLn4.js";
import { t as createClackPrompter } from "./clack-prompter-D_Aij1bU.js";
import { t as renderTable } from "./table-Bka4fasy.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-BCRDjJEJ.js";
import { n as redactSecrets } from "./format-yQZNwAF2.js";
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-BdLUX_VG.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DNOxnN50.js";
import { n as logConfigUpdated } from "./logging-BGewRZy0.js";
import { a as createVpsAwareOAuthHandlers, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-OlMnPz2w.js";
...
async function modelsListCommand(opts, runtime) {
	...
	const { ensureAuthProfileStore } = await import("./auth-profiles-Cn5oo5Dj.js").then((n) => n.t);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-CAOd95Vl.js").then((n) => n.t);
