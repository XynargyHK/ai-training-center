import { n as resolveConfigPath, r as resolveDefaultConfigCandidates, s as resolveStateDir, u as resolveRequiredHomeDir } from "./paths-Bp5uKvNR.js";
import { l as normalizeAgentId, n as DEFAULT_AGENT_ID } from "./session-key-CgcjHuX_.js";
import { D as isRecord, E as isPlainObject$2, M as resolveConfigDir, P as resolveUserPath, o as normalizeChatChannelId, t as CHANNEL_IDS } from "./registry-DykAc8X1.js";
import { c as resolveDefaultAgentId, s as resolveAgentWorkspaceDir } from "./agent-scope-BXfmtC-7.js";
import { A as shouldDeferShellEnvFallback, O as loadShellEnvFallback, X as DEFAULT_CONTEXT_TOKENS, j as shouldEnableShellEnvFallback, k as resolveShellEnvFallbackTimeoutMs, l as parseModelRef } from "./model-selection-CAfIlaZ9.js";
import { c as resolveMemorySlotDecision, o as normalizePluginsConfig, s as resolveEnableState, t as loadPluginManifestRegistry } from "./manifest-registry-B7RoObex.js";
...
//#endregion
export { VERSION as C, resolveAgentMaxConcurrent as S, getConfigValueAtPath as _, writeConfigFile as a, unsetConfigValueAtPath as b, TELEGRAM_COMMAND_NAME_PATTERN as c, parseDurationMs as d, validateJsonSchemaValue as f, unsetConfigOverride as g, setConfigOverride as h, resolveConfigSnapshotHash as i, normalizeTelegramCommandName as l, resetConfigOverrides as m, loadConfig as n, validateConfigObjectWithPlugins as o, getConfigOverrides as p, readConfigFileSnapshot as r, parseByteSize as s, createConfigIO as t, resolveTelegramCustomCommands as u, parseConfigPath as v, isSafeExecutableValue as x, setConfigValueAtPath as y };