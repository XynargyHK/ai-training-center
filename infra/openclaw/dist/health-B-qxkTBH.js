...
import { Dt as theme, Et as isRich, X as escapeRegExp, _ as defaultRuntime, gt as info, n as isTruthyEnvValue, o as createSubsystemLogger } from "./entry.js";
import { d as resolveAgentIdFromSessionKey, h as toAgentStoreSessionKey, l as normalizeAgentId } from "./session-key-BGiG_JcT.js";
import { c as resolveDefaultAgentId, h as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, s as resolveAgentWorkspaceDir } from "./agent-scope-F21xRiu_.js";
import { _ as parseDurationMs, i as loadConfig } from "./config-CQx0LPGX.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DETrZKco.js";
import { $n as isHeartbeatContentEffectivelyEmpty, An as resolveUserTimezone, Gn as getQueueSize, I as appendCronStyleCurrentTimeLine, J as resolveHeartbeatDeliveryTarget, P as getReplyFromConfig, Qn as DEFAULT_HEARTBEAT_EVERY, Qt as setHeartbeatWakeHandler, Xn as CommandLane, Y as resolveHeartbeatSenderContext, Zn as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Zt as requestHeartbeatNow, er as resolveHeartbeatPrompt$1, sn as peekSystemEventEntries, tr as stripHeartbeatToken } from "./subagent-registry-DN6TUJw4.js";
import { M as canonicalizeMainSessionAlias, N as resolveAgentMainSessionKey, i as loadSessionStore, l as updateSessionStore, s as saveSessionStore } from "./sessions-cLfvirnw.js";
import { t as HEARTBEAT_TOKEN } from "./tokens-MGcNqlE_.js";
import { a as resolvePreferredAccountId, t as buildChannelAccountBindings } from "./bindings-D1UzUf2-.js";
...
import { n as formatErrorMessage } from "./errors-BtWNsPzQ.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-CJeHSIux.js";
import { o as resolveEffectiveMessagesConfig } from "./reply-prefix-D0pmm6mE.js";
...
async function runHeartbeatOnce(opts) {
	...
	const pendingEvents = isExecEvent || isCronEventReason || hasTaggedCronEvents ? pendingEventEntries.map((event) => event.text) : [];
