import { Mt as resolveOpenClawAgentDir } from "./model-selection-CqXyRThV.js";
...
async function loadModelCatalog(params) {
	...
	modelCatalogPromise = (async () => {
		...
		try {
			...
			await (await import("./pi-auth-json-DBgGmct1.js")).ensurePiAuthJsonFromAuthProfiles(resolveOpenClawAgentDir());
