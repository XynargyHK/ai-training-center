import { At as getResolvedLoggerSettings, Pt as CONFIG_PATH, Ut as resolveGatewayPort, Wt as resolveIsNixMode, Yt as resolveStateDir, _ as defaultRuntime, dt as sleep, fn as resolveRequiredHomeDir, n as isTruthyEnvValue, qt as resolveOAuthDir, st as resolveUserPath, ut as shortenHomePath } from "./entry.js";
import { Bt as DEFAULT_PROVIDER, Ht as CLAUDE_CLI_PROFILE_ID, N as getModelRefStatus, S as updateAuthProfileStoreWithLock, U as resolveHooksGmailModel, Ut as CODEX_CLI_PROFILE_ID, V as resolveConfiguredModelRef, b as ensureAuthProfileStore, c as resolveApiKeyForProfile, p as repairOAuthProfileIdMismatch, s as resolveProfileUnusableUntilForDisplay, vt as resolveApiKeyForProvider, zt as DEFAULT_MODEL } from "./auth-profiles-Cn5oo5Dj.js";
import { t as formatCliCommand } from "./command-format-Cutkv9UT.js";
import { t as resolveOpenClawPackageRoot } from "./openclaw-root-wXF8iQtB.js";
import { n as runExec, t as runCommandWithTimeout } from "./exec-CBKBIMpA.js";
import { c as resolveDefaultAgentId, f as DEFAULT_AGENTS_FILENAME, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-F21xRiu_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BEoPa_Ui.js";
import { l as writeConfigFile, o as readConfigFileSnapshot } from "./config-CQx0LPGX.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-DETrZKco.js";
import { l as resolveGatewayBindHost, n as isLoopbackHost } from "./net-DsmdySgI.js";
import { h as loadOpenClawPlugins } from "./subagent-registry-DN6TUJw4.js";
import { F as resolveMainSessionKey, S as cleanStaleLockFiles, i as loadSessionStore } from "./sessions-cLfvirnw.js";
import { n as listChannelPlugins } from "./plugins-skOiRwEk.js";
import { D as DEFAULT_SANDBOX_IMAGE, E as DEFAULT_SANDBOX_COMMON_IMAGE, T as DEFAULT_SANDBOX_BROWSER_IMAGE, f as resolveSandboxScope } from "./sandbox-DOMEmZAG.js";
import { i as resolveGatewayAuth } from "./auth-QhLPyF5J.js";
import { i as formatPortDiagnostics, n as inspectPortUsage } from "./ports-B-sNNAH_.js";
import { c as resolveStorePath, n as resolveSessionFilePath, s as resolveSessionTranscriptsDirForAgent } from "./paths-CJeHSIux.js";
import { n as resolveMemorySearchConfig } from "./manager-y6B5FtH_.js";
import { n as loadModelCatalog } from "./model-catalog-d5K0907t.js";
import { i as readChannelAllowFromStore } from "./pairing-store-CWbTPkUY.js";
import { c as resolveGatewayLaunchAgentLabel, d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName, m as resolveNodeLaunchAgentLabel } from "./constants-BYmnCAgD.js";
import { h as randomToken, n as applyWizardMetadata, p as printWizardHeader, s as guardCancel } from "./onboard-helpers-Wi2a0F-c.js";
import { n as isWSLEnv, t as isWSL } from "./wsl-CQKBExj4.js";
import { n as stylePromptMessage, r as stylePromptTitle, t as stylePromptHint } from "./prompt-style-B_yUCLn4.js";
import { t as note$1 } from "./note-3kkap1pu.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-D7F4NeUu.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-IxMnCiES.js";
import { a as gatewayInstallErrorHint, d as renderSystemNodeWarning, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, p as resolveSystemNodeInfo, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-mdvWuLN7.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-ROJjoH-X.js";
import { a as launchAgentPlistExists, i as isLaunchAgentLoaded, o as repairLaunchAgentBootstrap, r as isLaunchAgentListed, s as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-ClCA6owG.js";
import { i as auditGatewayServiceConfig, n as renderSystemdUnavailableHints, o as needsNodeRuntimeMigration, r as SERVICE_AUDIT_CODES, s as formatRuntimeStatus, t as isSystemdUnavailableDetail } from "./systemd-hints-C2n6cQfN.js";
import { t as readLastGatewayErrorLine } from "./diagnostics-CK4NIDhc.js";
import { n as renderGatewayServiceCleanupHints, t as findExtraGatewayServices } from "./inspect-CdfH2Xcu.js";
import { r as healthCommand } from "./health-B-qxkTBH.js";
import { n as resolveControlUiDistIndexHealth, r as resolveControlUiDistIndexPathForRoot } from "./control-ui-assets-D2eHIaCV.js";
...
import { n as buildAuthHealthSummary, r as formatRemainingShort, t as DEFAULT_OAUTH_WARN_MS } from "./auth-health-CLxMS-gA.js";
import { n as detectLegacyStateMigrations, r as runLegacyStateMigrations, t as loadAndMaybeMigrateDoctorConfig } from "./doctor-config-flow-B-sydP6S.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-XTlpzS_-.js";
import { t as formatHealthCheckFailure } from "./health-format-AIh6mVyl.js";
import { n as doctorShellCompletion } from "./doctor-completion-DvSkJYlT.js";
