...
import { _ as DEFAULT_TOOLS_FILENAME, d as DEFAULT_AGENTS_FILENAME, f as DEFAULT_AGENT_WORKSPACE_DIR, g as DEFAULT_SOUL_FILENAME, h as DEFAULT_IDENTITY_FILENAME, l as resolveSessionAgentId, m as DEFAULT_HEARTBEAT_FILENAME, n as resolveAgentConfig, p as DEFAULT_BOOTSTRAP_FILENAME, v as DEFAULT_USER_FILENAME, y as ensureAgentWorkspace } from "./agent-scope-BXfmtC-7.js";
import { r as defaultRuntime, t as createSubsystemLogger } from "./subsystem-BxhC68lz.js";
import { n as runExec } from "./exec-C2VmzI_A.js";
import { K as resolveProcessScopedMap, q as isPidAlive } from "./model-selection-CAfIlaZ9.js";
import { t as formatCliCommand } from "./command-format-BUxhT1xL.js";
import { n as parseBooleanValue } from "./env-DUOlMsCb.js";
import { t as normalizeChatType } from "./chat-type-CTrit63N.js";
import { r as normalizeChannelId } from "./plugins-BoBVB9U9.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-C6NjWV99.js";
import { a as resizeToJpeg, m as extensionForMime, n as getImageMetadata, p as detectMime } from "./image-ops-BoI24SLx.js";
import { a as listDeliverableMessageChannels, o as normalizeMessageChannel } from "./message-channel-BCOlFUGm.js";
import { a as writeConfigFile, d as parseDurationMs, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-BseT0AMx.js";
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, E as DEFAULT_AI_SNAPSHOT_MAX_CHARS, O as DEFAULT_BROWSER_EVALUATE_ENABLED, T as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as ensureChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, x as isLoopbackHost, y as stopChromeExtensionRelayServer } from "./chrome-DiS0RF9Q.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, u as resolveSandboxPath } from "./skills-CPs8xDL7.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-C7sgRdrp.js";
import { n as resolveConversationLabel } from "./conversation-label-DL3BLtvs.js";
import { a as resolveSessionTranscriptPathInDir, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, s as resolveStorePath, t as resolveDefaultSessionStorePath } from "./paths-BHRTOOlS.js";
import { t as emitSessionTranscriptUpdate } from "./transcript-events-DUQC5hbS.js";
import { t as sanitizeContentBlocksImages } from "./tool-images-DrWTxQCS.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-CIpaMo8P.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-CIpaMo8P.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeSessionDeliveryFields as $, isTransientHttpError as A, getBridgeAuthForPort as At, loadSessionStore as B, normalizeToolName as Bt, isContextOverflowError as C, registerBrowserRoutes as Ct, isRateLimitAssistantError as D, saveMediaBuffer as Dt, isLikelyContextOverflowError as E, getMediaDir as Et, resolveSandboxContext as F, buildPluginToolGroups as Ft, updateSessionStore as G, buildBootstrapContextFiles as Gt, recordSessionMetaFromInbound as H, stripPluginOnlyAllowlist as Ht, resolveSandboxRuntimeStatus as I, collectExplicitAllowlist as It, resolveCacheTtlMs as J, resolveBootstrapTotalMaxChars as Jt, updateSessionStoreEntry as K, ensureSessionHeader$1 as Kt, extractDeliveryInfo as L, expandPolicyWithPluginGroups as Lt, parseImageSizeError as M, resolveBrowserControlAuth as Mt, sanitizeUserFacingText as N, resolveSandboxConfigForAgent as Nt, isRawApiErrorPayload as O, DEFAULT_UPLOAD_DIR as Ot, ensureSandboxWorkspaceForSession as P, applyOwnerOnlyToolPolicy as Pt, normalizeDeliveryContext as Q, appendAssistantMessageToSessionTranscript as R, expandToolGroups as Rt, isCompactionFailureError as S, createBrowserRouteContext as St, isFailoverErrorMessage as T, resolveProfile as Tt, saveSessionStore as U, compileGlobPatterns as Ut, readSessionUpdatedAt as V, resolveToolProfilePolicy as Vt, updateLastRoute as W, matchesAnyGlobPattern as Wt, deliveryContextKey as X, deliveryContextFromSession as Y, sanitizeGoogleTurnOrdering as Yt, mergeDeliveryContext as Z, formatRawAssistantErrorForUi as _, resolveFreshSessionTotalTokens as _t, isMessagingToolDuplicateNormalized as a, applyInputProvenanceToUserMessage as at, isBillingAssistantError as b, deriveSessionMetaPatch as bt, extractToolCallsFromAssistant as c, acquireSessionWriteLock as ct, isAntigravityClaude as d, evaluateSessionFreshness as dt, archiveSessionTranscripts as et, isGoogleModelApi as f, resolveChannelResetConfig as ft, formatBillingErrorMessage as g, DEFAULT_RESET_TRIGGERS as gt, formatAssistantErrorText as h, resolveThreadFlag as ht, isMessagingToolDuplicate as i, INPUT_PROVENANCE_KIND_VALUES as it, parseImageDimensionError as j, ensureBrowserControlAuth as jt, isTimeoutErrorMessage as k, resolvePathsWithinRoot as kt, extractToolResultId as l, resolveSessionLockMaxHoldFromTimeout as lt, classifyFailoverReason as m, resolveSessionResetType as mt, validateGeminiTurns as n, countToolResults as nt, normalizeTextForComparison as o, hasInterSessionUserProvenance as ot, BILLING_ERROR_USER_MESSAGE as p, resolveSessionResetPolicy as pt, isCacheEnabled as q, resolveBootstrapMaxChars as qt, pickFallbackThinkingLevel as r, extractToolCallNames as rt, sanitizeSessionMessagesImages as s, normalizeInputProvenance as st, validateAnthropicTurns as t, capArrayByJsonBytes as tt, downgradeOpenAIReasoningBlocks as u, resolveSessionKey as ut, getApiErrorPayloadFingerprint as v, canonicalizeMainSessionAlias as vt, isFailoverAssistantError as w, resolveBrowserConfig as wt, isCloudCodeAssistFormatError as x, resolveGroupSessionKey as xt, isAuthAssistantError as y, resolveMainSessionKey as yt, resolveMirroredTranscriptText as z, mergeAlsoAllowPolicy as zt };