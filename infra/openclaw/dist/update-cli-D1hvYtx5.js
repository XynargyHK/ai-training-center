import { Dt as theme, Yt as resolveStateDir, _ as defaultRuntime, rt as pathExists } from "./entry.js";
import "./auth-profiles-Cn5oo5Dj.js";
import { n as replaceCliName, r as resolveCliName, t as formatCliCommand } from "./command-format-Cutkv9UT.js";
...
import { ct as trimLogTail } from "./subagent-registry-DN6TUJw4.js";
...
import { c as resolveGatewayLaunchAgentLabel, d as resolveGatewaySystemdServiceName, f as resolveGatewayWindowsTaskName } from "./constants-BYmnCAgD.js";
...
import { n as stylePromptMessage, t as stylePromptHint } from "./prompt-style-B_yUCLn4.js";
...
import "./register.subclis-COKbecz0.js";
import "./command-registry-BQqvjyWT.js";
import "./program-context-Ccaxp4DE.js";
import { r as installCompletion } from "./completion-cli-C1Oq9TUp.js";
import "./daemon-runtime-mdvWuLN7.js";
import { r as parseSemver } from "./runtime-guard-kzIyHhvr.js";
import "./systemd-ROJjoH-X.js";
import { t as resolveGatewayService } from "./service-ClCA6owG.js";
import "./lifecycle-core-B1gvnBTv.js";
import "./systemd-hints-C2n6cQfN.js";
import { r as runDaemonRestart } from "./daemon-cli-BqahwtIW.js";
...
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, d as formatUpdateChannelLabel, g as resolveUpdateChannelDisplay, h as resolveEffectiveUpdateChannel, m as normalizeUpdateChannel, n as compareSemverStrings, r as fetchNpmTagVersion, s as DEFAULT_GIT_CHANNEL, t as checkUpdateStatus, u as channelToNpmTag } from "./update-check-BxNV3xAX.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-Bg1vuigt.js";
import { a as detectGlobalInstallManagerForRoot, c as readPackageName, i as detectGlobalInstallManagerByPresence, l as readPackageVersion, n as runGatewayUpdate, o as globalInstallArgs, r as cleanupGlobalRenameDirs, s as resolveGlobalPackageRoot } from "./session-dirs-C7BEi0VV.js";
import "./logging-BGewRZy0.js";
import "./auth-health-CLxMS-gA.js";
import { n as updateNpmInstalledPlugins, t as syncPluginsForUpdateChannel } from "./update-m9BYHl8F.js";
import "./doctor-config-flow-B-sydP6S.js";
import "./systemd-linger-XTlpzS_-.js";
import "./health-format-AIh6mVyl.js";
import { t as doctorCommand } from "./doctor-Ag6IWO4E.js";
import { r as ensureCompletionCacheExists, t as checkShellCompletionStatus } from "./doctor-completion-DvSkJYlT.js";
	...
	if (params.shouldRestart) {
		...
		try {
			...
			if (!params.opts.json && restartInitiated) {
				...
				defaultRuntime.log(theme.muted(`Verify with \`${replaceCliName(formatCliCommand("openclaw gateway status"), CLI_NAME)}\` once the gateway is back.`));
				defaultRuntime.log("");
			}
		} catch (err) {
			if (!params.opts.json) {
...
async function updateCommand(opts) {
	...
	if (shouldRestart) try {
		if (await resolveGatewayService().isLoaded({ env: process.env })) restartScriptPath = await prepareRestartScript(process.env);
	} catch {}
