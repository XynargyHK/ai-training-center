import { _ as defaultRuntime, w as DEFAULT_CHAT_CHANNEL } from "./entry.js";
import { Bt as DEFAULT_PROVIDER, F as modelKey, G as resolveThinkingDefault, I as normalizeModelRef, P as isCliProvider, Rt as DEFAULT_CONTEXT_TOKENS, V as resolveConfiguredModelRef, b as ensureAuthProfileStore, k as buildAllowedModelSet, zt as DEFAULT_MODEL } from "./auth-profiles-Cn5oo5Dj.js";
import { t as formatCliCommand } from "./command-format-Cutkv9UT.js";
import { d as resolveAgentIdFromSessionKey, l as normalizeAgentId, u as normalizeMainKey } from "./session-key-BGiG_JcT.js";
import { S as ensureAgentWorkspace, a as resolveAgentModelPrimary, l as resolveEffectiveModelFallbacks, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, u as resolveSessionAgentId } from "./agent-scope-F21xRiu_.js";
import { r as buildWorkspaceSkillSnapshot } from "./skills-BDAyXEfy.js";
import { i as loadConfig } from "./config-CQx0LPGX.js";
import { a as isInternalMessageChannel, d as resolveMessageChannel, i as isGatewayMessageChannel, l as normalizeMessageChannel, n as isDeliverableMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-B9mgJ1nn.js";
import { B as runCliAgent, Mt as AGENT_LANE_SUBAGENT, R as getCliSessionId, X as resolveOutboundTarget, Z as resolveSessionDeliveryTarget, en as resolveSendPolicy, jt as AGENT_LANE_NESTED, nn as applyModelOverrideToSessionEntry, nr as clearAgentRunContext, or as registerAgentRunContext, rn as applyVerboseOverride, rr as emitAgentEvent, s as runEmbeddedPiAgent, tn as clearSessionAuthProfileOverride, tt as runWithModelFallback, vn as resolveAgentTimeoutMs, z as setCliSessionId } from "./subagent-registry-DN6TUJw4.js";
import { D as resolveSessionResetPolicy, E as resolveChannelResetConfig, K as normalizeAccountId, O as resolveSessionResetType, P as resolveExplicitAgentSessionKey, T as evaluateSessionFreshness, i as loadSessionStore, l as updateSessionStore, w as resolveSessionKey } from "./sessions-cLfvirnw.js";
import { r as normalizeChannelId, t as getChannelPlugin } from "./plugins-skOiRwEk.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "./deliver-CkuuwqYG.js";
import { c as resolveStorePath, n as resolveSessionFilePath } from "./paths-CJeHSIux.js";
import { d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BMF5Lj9k.js";
import { n as loadModelCatalog } from "./model-catalog-d5K0907t.js";
import { u as lookupContextTokens } from "./session-utils-BRFnL9HI.js";
import { O as getSkillsSnapshotVersion, o as getRemoteSkillEligibility } from "./skill-commands-CwUsNtLP.js";
import { c as hasNonzeroUsage, s as deriveSessionTotalTokens } from "./session-cost-usage-BR5wNTCV.js";
import { n as createDefaultDeps, t as createOutboundSendDeps } from "./outbound-send-deps-roW8iOoy.js";
