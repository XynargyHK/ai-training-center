...
import { r as DEFAULT_CHAT_CHANNEL } from "../../registry-BVeYESaO.js";
import { a as resolveAgentModelPrimary, l as resolveEffectiveModelFallbacks, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, u as resolveSessionAgentId } from "../../agent-scope-C7eW-ntH.js";
import { r as defaultRuntime, t as createSubsystemLogger } from "../../subsystem-D5Ceunbp.js";
import "../../exec-Bx7QVAB1.js";
import { l as ensureAgentWorkspace } from "../../workspace-yaPyeH-7.js";
import { n as SILENT_REPLY_TOKEN } from "../../tokens-OrzXQ-4r.js";
...
import { r as normalizeChannelId, t as getChannelPlugin } from "../../plugins-DSZtXzTw.js";
import "../../send-BwmoncfZ.js";
import { a as normalizeOutboundPayloadsForJson, i as normalizeOutboundPayloads, r as formatOutboundPayloadLog, t as deliverOutboundPayloads } from "../../deliver-CHEVUMg8.js";
...
import { C as buildAllowedModelSet, D as isCliProvider, F as resolveThinkingDefault, G as DEFAULT_PROVIDER, M as resolveConfiguredModelRef, O as modelKey, U as DEFAULT_CONTEXT_TOKENS, W as DEFAULT_MODEL, _ as ensureAuthProfileStore, k as normalizeModelRef } from "../../model-auth-XLztKWJW.js";
import "../../github-copilot-token-Cxe2rXZ6.js";
import "../../pi-model-discovery-DIA4gIzW.js";
import { i as isInternalMessageChannel, l as resolveMessageChannel, n as isDeliverableMessageChannel, r as isGatewayMessageChannel, s as normalizeMessageChannel, t as INTERNAL_MESSAGE_CHANNEL } from "../../message-channel-cdJiiX-Z.js";
...
import { n as buildWorkspaceSkillSnapshot } from "../../skills-CUSbMCKQ.js";
import "../../redact-9hYpOXID.js";
import "../../errors-pj0CRkCB.js";
import "../../store-ugiSLvrA.js";
import { c as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeThinkLevel, t as formatThinkingLevels, u as supportsXHighThinking } from "../../thinking-DRMTMy-D.js";
import "../../accounts-hscXw7_x.js";
import { n as resolveSessionFilePath, s as resolveStorePath } from "../../paths-B4zRLe0K.js";
...
import { s as loadModelCatalog } from "../../runner-Cg70cGAY.js";
import { c as getSkillsSnapshotVersion, o as getRemoteSkillEligibility } from "../../skill-commands-DsSH9W9O.js";
...
function createDefaultDeps() {
	return {
		sendMessageWhatsApp: async (...args) => {
			const { sendMessageWhatsApp } = await import("../../web-Bg3h6n1h.js");
			return await sendMessageWhatsApp(...args);
		},
		sendMessageTelegram: async (...args) => {
			const { sendMessageTelegram } = await import("../../send-jxA1TeNr.js").then((n) => n.l);
			return await sendMessageTelegram(...args);
		},
		sendMessageDiscord: async (...args) => {
			const { sendMessageDiscord } = await import("../../send-BwmoncfZ.js").then((n) => n.t);
			return await sendMessageDiscord(...args);
		},
		sendMessageSlack: async (...args) => {
			const { sendMessageSlack } = await import("../../send-D0SAMQ1Z.js").then((n) => n.n);
			return await sendMessageSlack(...args);
		},
		sendMessageSignal: async (...args) => {
			const { sendMessageSignal } = await import("../../send-DDU01FQx.js").then((n) => n.i);
			return await sendMessageSignal(...args);
		},
		sendMessageIMessage: async (...args) => {
			const { sendMessageIMessage } = await import("../../send-BYB8fOBI.js").then((n) => n.n);
