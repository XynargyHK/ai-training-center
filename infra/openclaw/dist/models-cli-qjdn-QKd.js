...
import { B as theme, C as shortenHomePath, R as colorize, z as isRich$1 } from "./utils-CFnnyoTP.js";
import "./thinking-EAliFiVK.js";
import { Ft as formatUsageWindowSummary, It as resolveUsageProviderId, Nt as loadProviderUsageSummary, m as runEmbeddedPiAgent, q as describeFailoverError } from "./reply-oSe13ewW.js";
import "./registry-D74-I5q-.js";
import { f as defaultRuntime } from "./subsystem-oVAQxyhr.js";
import "./exec-i2CMvUxK.js";
import { E as resolveDefaultAgentWorkspaceDir, a as resolveAgentModelPrimary, c as resolveDefaultAgentId, i as resolveAgentModelFallbacksOverride, r as resolveAgentDir, s as resolveAgentWorkspaceDir } from "./agent-scope-CrP-i2MF.js";
import { $ as shouldEnableShellEnvFallback, Dt as ensureAuthProfileStore, G as resolveAwsSdkEnvVarName, H as getCustomProviderApiKey, Ht as DEFAULT_MODEL, J as getShellEnvAppliedKeys, K as resolveEnvApiKey, Mt as resolveOpenClawAgentDir, Rt as resolveAuthProfileDisplayLabel, St as listProfilesForProvider, Tt as upsertAuthProfile, Ut as DEFAULT_PROVIDER, W as resolveApiKeyForProvider, g as resolveModelRefFromString, i as findNormalizedProviderValue, jt as resolveAuthStorePathForDisplay, l as normalizeProviderId, lt as resolveAuthProfileOrder, m as resolveDefaultModelForAgent, mt as resolveProfileUnusableUntilForDisplay, p as resolveConfiguredModelRef, r as buildModelAliasIndex, s as modelKey, u as parseModelRef, wt as setAuthProfileOrder } from "./model-selection-CqXyRThV.js";
...
import { _ as parseDurationMs, i as loadConfig, o as readConfigFileSnapshot } from "./config-F0Q6PyfW.js";
import "./manifest-registry-DoaWeDHN.js";
import "./runner-CtkNTG0l.js";
import "./image-DIIFeXgf.js";
import { t as ensureOpenClawModelsJson } from "./models-config-Bte9XHxc.js";
...
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-gjLMn4eA.js";
...
import { i as resolveForwardCompatModel, r as ANTIGRAVITY_OPUS_46_FORWARD_COMPAT_CANDIDATES } from "./model-Br9l2OSe.js";
import { t as ensurePiAuthJsonFromAuthProfiles } from "./model-COh_V8Hw.js";
...
import { n as runCommandWithRuntime, t as resolveOptionFromCommand } from "./cli-utils-BqMwAlgf.js";
import "./help-format-BwCqDl6O.js";
import { r as withProgressTotals } from "./progress-By07Lltm.js";
...
import { f as openUrl } from "./onboard-helpers-BClizJPp.js";
...
import { t as createClackPrompter } from "./clack-prompter-DUSORdwR.js";
import { t as renderTable } from "./table-Dlw499e9.js";
import { t as inferParamBFromIdOrName } from "./model-param-b-D1rP7U2U.js";
import { n as redactSecrets } from "./format-DNqZrSx7.js";
import { a as isLocalBaseUrl, c as resolveKnownAgentId, d as updateConfig, i as formatTokenK, l as resolveModelKeysFromEntries, n as ensureFlagCompatibility, o as mergePrimaryFallbackConfig, r as formatMs, s as normalizeAlias, t as applyDefaultModelPrimaryUpdate, u as resolveModelTarget } from "./shared-JgVAtphM.js";
import { d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-UHqYNb79.js";
import { n as logConfigUpdated } from "./logging-9hXqNouw.js";
import { a as createVpsAwareOAuthHandlers, c as githubCopilotLoginCommand, i as resolveProviderMatch, n as mergeConfigPatch, o as isRemoteEnvironment, r as pickAuthMethod, s as resolvePluginProviders, t as applyDefaultModel } from "./provider-auth-helpers-5hW0-_DT.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { loadConfig } = await import("./config-F0Q6PyfW.js").then((n) => n.t);
	const { ensureAuthProfileStore } = await import("./model-selection-CqXyRThV.js").then((n) => n.ct);
	const cfg = loadConfig();
	...
	if (opts.all) {
		...
		if (!model) {
			const { resolveModel } = await import("./model-COh_V8Hw.js");
