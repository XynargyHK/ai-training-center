...
import { I as resolveUserPath, M as normalizeE164, U as truncateUtf16Safe, t as CHANNEL_IDS, ut as resolvePreferredOpenClawTmpDir } from "./registry-BVeYESaO.js";
import { n as resolveAgentConfig, u as resolveSessionAgentId } from "./agent-scope-C7eW-ntH.js";
import { r as defaultRuntime, t as createSubsystemLogger } from "./subsystem-D5Ceunbp.js";
import { n as runExec } from "./exec-Bx7QVAB1.js";
import { a as DEFAULT_IDENTITY_FILENAME, c as DEFAULT_USER_FILENAME, i as DEFAULT_HEARTBEAT_FILENAME, l as ensureAgentWorkspace, n as DEFAULT_AGENT_WORKSPACE_DIR, o as DEFAULT_SOUL_FILENAME, r as DEFAULT_BOOTSTRAP_FILENAME, s as DEFAULT_TOOLS_FILENAME, t as DEFAULT_AGENTS_FILENAME } from "./workspace-yaPyeH-7.js";
import { t as normalizeChatType } from "./chat-type-kuHrgZ1E.js";
import { t as parseBooleanValue } from "./boolean-CE7i9tBR.js";
import { t as formatCliCommand } from "./command-format-DUn-q_CN.js";
import { r as normalizeChannelId } from "./plugins-DSZtXzTw.js";
import { a as resizeToJpeg, n as getImageMetadata } from "./image-ops-CjLvw22Q.js";
import { S as isPidAlive, x as resolveProcessScopedMap } from "./model-auth-XLztKWJW.js";
import { o as listDeliverableMessageChannels, s as normalizeMessageChannel } from "./message-channel-cdJiiX-Z.js";
import { a as writeConfigFile, d as parseDurationMs, n as loadConfig, s as parseByteSize, t as createConfigIO } from "./config-BNjb0X52.js";
import { A as DEFAULT_OPENCLAW_BROWSER_ENABLED, D as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, E as DEFAULT_AI_SNAPSHOT_MAX_CHARS, O as DEFAULT_BROWSER_EVALUATE_ENABLED, T as DEFAULT_AI_SNAPSHOT_EFFICIENT_MAX_CHARS, a as resolveOpenClawUserDataDir, c as captureScreenshot, d as normalizeCdpWsUrl, f as snapshotAria, h as fetchOk, i as launchOpenClawChrome, j as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, k as DEFAULT_OPENCLAW_BROWSER_COLOR, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, s as resolveBrowserExecutableForPlatform, v as ensureChromeExtensionRelayServer, w as DEFAULT_AI_SNAPSHOT_EFFICIENT_DEPTH, x as isLoopbackHost, y as stopChromeExtensionRelayServer } from "./chrome-B4TkRag4.js";
import { a as syncSkillsToWorkspace, l as resolveSandboxInputPath, u as resolveSandboxPath } from "./skills-CUSbMCKQ.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-pj0CRkCB.js";
import { r as saveMediaBuffer, t as ensureMediaDir } from "./store-ugiSLvrA.js";
import { n as resolveConversationLabel } from "./conversation-label-CCMdDIlq.js";
import { d as getChannelDock, o as normalizeThinkLevel } from "./thinking-DRMTMy-D.js";
...
import { t as sanitizeContentBlocksImages } from "./tool-images-DuFuIO-E.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-Dx3LY1jh.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-Dx3LY1jh.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { normalizeAccountId as $, isTransientHttpError as A, ensureBrowserControlAuth as At, loadSessionStore as B, resolveToolProfilePolicy as Bt, isContextOverflowError as C, createBrowserRouteContext as Ct, isRateLimitAssistantError as D, DEFAULT_UPLOAD_DIR as Dt, isLikelyContextOverflowError as E, resolveProfile as Et, resolveSandboxContext as F, collectExplicitAllowlist as Ft, updateSessionStoreEntry as G, ensureSessionHeader$1 as Gt, recordSessionMetaFromInbound as H, compileGlobPatterns as Ht, resolveSandboxRuntimeStatus as I, expandPolicyWithPluginGroups as It, deliveryContextFromSession as J, sanitizeGoogleTurnOrdering as Jt, isCacheEnabled as K, resolveBootstrapMaxChars as Kt, extractDeliveryInfo as L, expandToolGroups as Lt, parseImageSizeError as M, resolveSandboxConfigForAgent as Mt, sanitizeUserFacingText as N, applyOwnerOnlyToolPolicy as Nt, isRawApiErrorPayload as O, resolvePathsWithinRoot as Ot, ensureSandboxWorkspaceForSession as P, buildPluginToolGroups as Pt, normalizeSessionDeliveryFields as Q, appendAssistantMessageToSessionTranscript as R, mergeAlsoAllowPolicy as Rt, isCompactionFailureError as S, resolveGroupSessionKey as St, isFailoverErrorMessage as T, resolveBrowserConfig as Tt, updateLastRoute as U, matchesAnyGlobPattern as Ut, readSessionUpdatedAt as V, stripPluginOnlyAllowlist as Vt, updateSessionStore as W, buildBootstrapContextFiles as Wt, mergeDeliveryContext as X, deliveryContextKey as Y, normalizeDeliveryContext as Z, formatRawAssistantErrorForUi as _, resolveFreshSessionTotalTokens as _t, isMessagingToolDuplicateNormalized as a, applyInputProvenanceToUserMessage as at, isBillingAssistantError as b, resolveMainSessionKey as bt, extractToolCallsFromAssistant as c, acquireSessionWriteLock as ct, isAntigravityClaude as d, evaluateSessionFreshness as dt, archiveSessionTranscripts as et, isGoogleModelApi as f, resolveChannelResetConfig as ft, formatBillingErrorMessage as g, DEFAULT_RESET_TRIGGERS as gt, formatAssistantErrorText as h, resolveThreadFlag as ht, isMessagingToolDuplicate as i, INPUT_PROVENANCE_KIND_VALUES as it, parseImageDimensionError as j, resolveBrowserControlAuth as jt, isTimeoutErrorMessage as k, getBridgeAuthForPort as kt, extractToolResultId as l, resolveSessionLockMaxHoldFromTimeout as lt, classifyFailoverReason as m, resolveSessionResetType as mt, validateGeminiTurns as n, countToolResults as nt, normalizeTextForComparison as o, hasInterSessionUserProvenance as ot, BILLING_ERROR_USER_MESSAGE as p, resolveSessionResetPolicy as pt, resolveCacheTtlMs as q, resolveBootstrapTotalMaxChars as qt, pickFallbackThinkingLevel as r, extractToolCallNames as rt, sanitizeSessionMessagesImages as s, normalizeInputProvenance as st, validateAnthropicTurns as t, capArrayByJsonBytes as tt, downgradeOpenAIReasoningBlocks as u, resolveSessionKey as ut, getApiErrorPayloadFingerprint as v, canonicalizeMainSessionAlias as vt, isFailoverAssistantError as w, registerBrowserRoutes as wt, isCloudCodeAssistFormatError as x, deriveSessionMetaPatch as xt, isAuthAssistantError as y, resolveExplicitAgentSessionKey as yt, resolveMirroredTranscriptText as z, normalizeToolName as zt };