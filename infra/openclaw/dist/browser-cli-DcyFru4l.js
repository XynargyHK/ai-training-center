import { Dt as theme, Yt as resolveStateDir, _ as defaultRuntime, a as parseBooleanValue, gt as info, ht as danger, ut as shortenHomePath } from "./entry.js";
...
import { a as resolvePathsWithinRoot, r as DEFAULT_UPLOAD_DIR } from "./paths-DGpfJD4j.js";
...
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-BGR6Kzmq.js";
...
function normalizeUploadPaths(paths) {
...
function registerBrowserFilesAndDownloadsCommands(browser, parentOpts) {
	const runDownloadCommand = async (cmd, opts, request) => {
		const { parent, profile } = resolveBrowserActionContext(cmd, parentOpts);
		try {
			const timeoutMs = Number.isFinite(opts.timeoutMs) ? Number(opts.timeoutMs) : void 0;
