import { Ut as resolveGatewayPort } from "./entry.js";
import { i as loadConfig, l as writeConfigFile, r as createConfigIO } from "./config-CQx0LPGX.js";
import { n as isLoopbackHost } from "./net-DsmdySgI.js";
import { C as DEFAULT_BROWSER_DEFAULT_PROFILE_NAME, D as DEFAULT_OPENCLAW_BROWSER_PROFILE_NAME, E as DEFAULT_OPENCLAW_BROWSER_ENABLED, T as DEFAULT_OPENCLAW_BROWSER_COLOR, a as resolveOpenClawUserDataDir, d as normalizeCdpWsUrl, h as fetchOk, i as launchOpenClawChrome, l as createTargetViaCdp, m as fetchJson, n as isChromeCdpReady, o as stopOpenClawChrome, p as appendCdpPath, r as isChromeReachable, v as ensureChromeExtensionRelayServer, w as DEFAULT_BROWSER_EVALUATE_ENABLED, y as stopChromeExtensionRelayServer } from "./chrome-BjOblpOF.js";
import { i as resolveGatewayAuth } from "./auth-QhLPyF5J.js";
import { n as formatErrorMessage, t as extractErrorCode } from "./errors-BtWNsPzQ.js";
...
async function loadPwAiModule(mode) {
	try {
		return await import("./pw-ai-DMeIGu7s.js");
	} catch (err) {
...
function createProfileContext(opts, profile) {
	...
	const resetProfile = async () => {
		...
		if (await isHttpReachable(300) && !profileState.running) try {
			await (await import("./pw-ai-DMeIGu7s.js")).closePlaywrightBrowserConnection();
		} catch {}
...
//#endregion
export { resolveProfile as a, getUsedColors as c, deriveDefaultBrowserCdpPortRange as d, getPwAiModule as f, resolveBrowserConfig as i, getUsedPorts as l, resolveBrowserControlAuth as m, listKnownProfileNames as n, allocateCdpPort as o, ensureBrowserControlAuth as p, parseHttpUrl as r, allocateColor as s, createBrowserRouteContext as t, isValidProfileName as u };