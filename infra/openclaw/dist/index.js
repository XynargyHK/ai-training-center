...
import { Lt as resolveCommitHash, t as getReplyFromConfig } from "./reply-oSe13ewW.js";
...
import { L as VERSION, R as loadDotEnv, i as loadConfig } from "./config-F0Q6PyfW.js";
import "./manifest-registry-DoaWeDHN.js";
import { c as installUnhandledRejectionHandler, h as applyTemplate } from "./runner-CtkNTG0l.js";
...
import { A as deriveSessionKey, i as loadSessionStore, j as resolveSessionKey, s as saveSessionStore } from "./sessions-CHz-yoEe.js";
...
import { r as waitForever, t as monitorWebChannel } from "./channel-web-DW4qQLUs.js";
import "./outbound-C6la1NUD.js";
import "./session-Dy2jEJA1.js";
import "./login-5Lr0FZBh.js";
...
import { i as getCoreCliCommandsWithSubcommands, n as setProgramContext, o as registerProgramCommands, s as getSubCliCommandsWithSubcommands } from "./program-context-CcUjRSbm.js";
import "./catalog-DdTNZaU_.js";
import "./plugin-registry-BLwfpp2C.js";
import { n as resolveCliChannelOptions } from "./channel-options-C-vY8KFe.js";
...
function registerPreActionHooks(program, programVersion) {
	program.hook("preAction", async (_thisCommand, actionCommand) => {
		...
		const { ensureConfigReady } = await import("./config-guard-DUDIbmXD.js");
		await ensureConfigReady({
			runtime: defaultRuntime,
			commandPath
		});
		if (PLUGIN_REQUIRED_COMMANDS.has(commandPath[0])) {
			const { ensurePluginRegistryLoaded } = await import("./plugin-registry-BLwfpp2C.js").then((n) => n.n);
