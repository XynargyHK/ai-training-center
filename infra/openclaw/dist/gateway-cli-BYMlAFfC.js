import { $t as triggerInternalHook, At as getResolvedLoggerSettings, Dt as theme, Et as isRich, F as createEmptyPluginRegistry, Ht as resolveGatewayLockDir, It as STATE_DIR, Lt as isNixMode, M as getActivePluginRegistry, Ot as getChildLogger, Pt as CONFIG_PATH, Q as isPlainObject, Qt as registerInternalHook, S as CHANNEL_IDS, Tt as colorize, U as CONFIG_DIR, Ut as resolveGatewayPort, W as clamp, Xt as clearInternalHooks, Y as ensureDir, Yt as resolveStateDir, Zt as createInternalHookEvent, _ as defaultRuntime, d as setConsoleTimestampPrefix, dn as expandHomePrefix, kt as getLogger, mt as truncateUtf16Safe, n as isTruthyEnvValue, o as createSubsystemLogger, r as logAcceptedEnvOption, s as runtimeForLogger, st as resolveUserPath, u as setConsoleSubsystemFilter, ut as shortenHomePath, w as DEFAULT_CHAT_CHANNEL, xt as setVerbose, zt as resolveConfigPath } from "./entry.js";
import { Bt as DEFAULT_PROVIDER, Ct as normalizeSecretInput, G as resolveThinkingDefault, H as resolveDefaultModelForAgent, N as getModelRefStatus, O as isPidAlive, P as isCliProvider, Rt as DEFAULT_CONTEXT_TOKENS, U as resolveHooksGmailModel, V as resolveConfiguredModelRef, z as resolveAllowedModelRef, zt as DEFAULT_MODEL } from "./auth-profiles-Cn5oo5Dj.js";
...
import { r as matchesSkillFilter, t as resolveOpenClawPackageRoot } from "./openclaw-root-wXF8iQtB.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-CBKBIMpA.js";
import { D as resolveWorkspaceTemplateDir, E as resolveDefaultAgentWorkspaceDir, S as ensureAgentWorkspace, _ as DEFAULT_MEMORY_ALT_FILENAME, b as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, i as resolveAgentModelFallbacksOverride, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, u as resolveSessionAgentId, v as DEFAULT_MEMORY_FILENAME, w as isWorkspaceOnboardingCompleted, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./agent-scope-F21xRiu_.js";
import "./github-copilot-token-DuFIqfeC.js";
import "./model-CAOd95Vl.js";
import "./pi-model-discovery-Do3xMEtM.js";
import { d as hasBinary } from "./frontmatter-DRl3Sa-X.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BDAyXEfy.js";
import { s as isTestDefaultMemorySlotDisabled } from "./manifest-registry-CYUiqtAr.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BEoPa_Ui.js";
...
import { $ as validateNodePairRequestParams, A as validateCronStatusParams, B as validateExecApprovalsNodeGetParams, C as validateConfigSetParams, Ct as validateWizardCancelParams, D as validateCronRemoveParams, Dt as PROTOCOL_VERSION, E as validateCronListParams, Et as validateWizardStatusParams, F as validateDeviceTokenRevokeParams, Ft as deriveDeviceIdFromPublicKey, G as validateNodeDescribeParams, H as validateExecApprovalsSetParams, I as validateDeviceTokenRotateParams, J as validateNodeInvokeResultParams, K as validateNodeEventParams, L as validateExecApprovalRequestParams, Lt as normalizeDevicePublicKeyBase64Url, M as validateDevicePairApproveParams, Mt as buildDeviceAuthPayload, N as validateDevicePairListParams, Nt as normalizeDeviceAuthScopes, O as validateCronRunParams, Ot as ErrorCodes, P as validateDevicePairRejectParams, Q as validateNodePairRejectParams, R as validateExecApprovalResolveParams, Rt as verifyDeviceSignature, S as validateConfigSchemaParams, St as validateWebLoginWaitParams, T as validateCronAddParams, Tt as validateWizardStartParams, U as validateLogsTailParams, V as validateExecApprovalsNodeSetParams, W as validateModelsListParams, X as validateNodePairApproveParams, Y as validateNodeListParams, Z as validateNodePairListParams, _ as validateChatInjectParams, _t as validateTalkConfigParams, a as validateAgentWaitParams, at as validateSessionsCompactParams, b as validateConfigGetParams, bt as validateWakeParams, c as validateAgentsFilesGetParams, ct as validateSessionsPatchParams, d as validateAgentsListParams, dt as validateSessionsResolveParams, et as validateNodePairVerifyParams, f as validateAgentsUpdateParams, ft as validateSessionsUsageParams, g as validateChatHistoryParams, gt as validateSkillsUpdateParams, h as validateChatAbortParams, ht as validateSkillsStatusParams, i as validateAgentParams, it as validateSendParams, j as validateCronUpdateParams, jt as parseSessionLabel, k as validateCronRunsParams, kt as errorShape, l as validateAgentsFilesListParams, lt as validateSessionsPreviewParams, m as validateChannelsStatusParams, mt as validateSkillsInstallParams, n as formatValidationErrors, nt as validatePollParams, o as validateAgentsCreateParams, ot as validateSessionsDeleteParams, p as validateChannelsLogoutParams, pt as validateSkillsBinsParams, q as validateNodeInvokeParams, r as validateAgentIdentityParams, rt as validateRequestFrame, s as validateAgentsDeleteParams, st as validateSessionsListParams, tt as validateNodeRenameParams, u as validateAgentsFilesSetParams, ut as validateSessionsResetParams, v as validateChatSendParams, vt as validateTalkModeParams, w as validateConnectParams, wt as validateWizardNextParams, x as validateConfigPatchParams, xt as validateWebLoginStartParams, y as validateConfigApplyParams, yt as validateUpdateRunParams, z as validateExecApprovalsGetParams } from "./client-B0TEt50q.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-2NwZRUW_.js";
import { n as callGateway, o as loadGatewayTlsRuntime$1 } from "./call-DETrZKco.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-B9mgJ1nn.js";
import { c as pickPrimaryLanIPv4, d as resolveGatewayListenHosts, f as resolveHostName, i as isTrustedProxyAddress, l as resolveGatewayBindHost, n as isLoopbackHost, o as normalizeHostHeader, p as rawDataToString, r as isPrivateOrLoopbackAddress, t as isLoopbackAddress, u as resolveGatewayClientIp } from "./net-DsmdySgI.js";
import { i as normalizeInputProvenance } from "./input-provenance-BPpmKfDN.js";
import { $ as resetDirectoryCache, $t as normalizeSendPolicy, A as dispatchInboundMessage, An as resolveUserTimezone, At as persistBrowserProxyFiles, B as runCliAgent, Bn as setTtsProvider, Bt as setPreRestartDeferralCheck, Cn as formatZonedTimestamp, Dn as stopSubagentsForRequester, Dt as getHookType, En as isAbortTrigger, Et as detectSuspiciousPatterns, F as BARE_SESSION_RESET_PROMPT, Fn as resolveTtsAutoMode, Ft as emitGatewayRestart, H as createOpenClawTools, Hn as OPENAI_TTS_MODELS, In as resolveTtsConfig, It as isGatewaySigusr1RestartExternallyAllowed, Jn as setCommandLaneConcurrency, K as ensureOutboundSessionEntry, Kn as getTotalQueueSize, L as resolveCronStyleNow, Ln as resolveTtsPrefsPath, Lt as markGatewaySigusr1RestartHandled, M as getTotalPendingReplies, Mn as isTtsEnabled, Nn as isTtsProviderConfigured, Nt as consumeGatewaySigusr1RestartAuthorization, Ot as isExternalHookSession, Pn as resolveTtsApiKey, Pt as deferGatewayRestartUntilIdle, R as getCliSessionId, Rn as resolveTtsProviderOrder, Rt as scheduleGatewaySigusr1Restart, St as stripLegacyDeliveryFields, T as buildHistoryContextFromEntries, Tt as buildSafeExternalPrompt, U as readLatestAssistantReply, Un as OPENAI_TTS_VOICES, Ut as loadProviderUsageSummary, Vn as textToSpeech, Vt as normalizeGroupActivation, W as resolveAnnounceTargetFromKey, Wn as getActiveTaskCount, X as resolveOutboundTarget, Xn as CommandLane, Yn as waitForActiveTasks, Z as resolveSessionDeliveryTarget, Zn as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, Zt as requestHeartbeatNow, _ as handleSlackHttpRequest, _t as normalizePayloadToSystemText, a as runSubagentAnnounceFlow, an as enqueueSystemEvent, ar as onAgentEvent, at as formatRestartSentinelMessage, b as computeBackoff, bt as buildDeliveryFromLegacyPayload, c as abortEmbeddedPiRun, d as applyToolPolicyPipeline, dn as DEFAULT_INPUT_MAX_REDIRECTS, dt as normalizeCronJobCreate, en as resolveSendPolicy, f as buildDefaultToolPolicyPipelineSteps, fn as DEFAULT_INPUT_TIMEOUT_MS, ft as normalizeCronJobPatch, gn as resolveInputFileLimits, gt as normalizeOptionalText, h as loadOpenClawPlugins, hn as normalizeMimeList, ht as normalizeOptionalSessionKey, in as parseVerboseOverride, ir as getAgentRunContext, it as formatDoctorNonInteractiveHint, j as createReplyDispatcher, jn as getTtsProvider, kt as applyBrowserProxyPaths, l as getActiveEmbeddedRunCount, ln as DEFAULT_INPUT_IMAGE_MAX_BYTES, lt as writeRestartSentinel, m as getPluginToolMeta, mn as extractImageContentFromSource, mt as normalizeOptionalAgentId, n as initSubagentRegistry, nn as applyModelOverrideToSessionEntry, nr as clearAgentRunContext, o as clearSessionQueues, on as isSystemEventContextChanged, or as registerAgentRunContext, pn as extractFileContentFromSource, pt as inferLegacyName, q as resolveOutboundSessionRoute, qn as resetAllLanes, r as listDescendantRunsForRequester, rn as applyVerboseOverride, rr as emitAgentEvent, rt as consumeRestartSentinel, s as runEmbeddedPiAgent, st as summarizeRestartSentinel, t as countActiveDescendantRuns, tr as stripHeartbeatToken, tt as runWithModelFallback, u as waitForEmbeddedPiRunEnd, un as DEFAULT_INPUT_IMAGE_MIMES, ut as normalizeHttpWebhookUrl, v as readJsonBodyWithLimit, vn as resolveAgentTimeoutMs, vt as normalizeRequiredName, x as sleepWithAbort, xt as hasLegacyDeliveryHints, y as requestBodyErrorToText, yt as migrateLegacyCronPayload, z as setCliSessionId, zn as setTtsEnabled, zt as setGatewaySigusr1RestartPolicy } from "./subagent-registry-DN6TUJw4.js";
import { D as resolveSessionResetPolicy, F as resolveMainSessionKey, G as normalizeSessionDeliveryFields, I as resolveMainSessionKeyFromConfig, M as canonicalizeMainSessionAlias, N as resolveAgentMainSessionKey, P as resolveExplicitAgentSessionKey, R as snapshotSessionOrigin, S as cleanStaleLockFiles, T as evaluateSessionFreshness, U as mergeDeliveryContext, V as deliveryContextFromSession, _ as readSessionPreviewItemsFromTranscript, b as stripEnvelopeFromMessages, g as readSessionMessages, h as capArrayByJsonBytes, i as loadSessionStore, l as updateSessionStore, m as archiveSessionTranscripts, p as archiveFileOnDisk, t as extractDeliveryInfo, y as resolveSessionTranscriptCandidates } from "./sessions-cLfvirnw.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyText } from "./tokens-MGcNqlE_.js";
import "./accounts-BSDGn_Eo.js";
import "./normalize-BOd1bq0W.js";
import { t as buildChannelAccountBindings } from "./bindings-D1UzUf2-.js";
import "./logging-CcxUDNcI.js";
import "./send-B3cNBurL.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-skOiRwEk.js";
import "./send-YkE1T1ys.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-qnpLqckm.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CkuuwqYG.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-CBjdyWIE.js";
import "./diagnostic-session-state-DqgfGYqZ.js";
import "./accounts-Cavy4S5h.js";
import "./send-C1DPz5bm.js";
import { o as detectMime } from "./image-ops-DOCAfk8A.js";
import "./pi-embedded-helpers-BKS_5Gh6.js";
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-DOMEmZAG.js";
import "./chrome-BjOblpOF.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-ByXUFHKh.js";
import { t as safeEqualSecret } from "./secret-equal-BEUvDo67.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, i as resolveGatewayAuth, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured } from "./auth-QhLPyF5J.js";
import "./server-context-BEuO2lgK.js";
import "./routes-ChQCcH6s.js";
import "./redact-BHDVlHmj.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-BtWNsPzQ.js";
import "./paths-DGpfJD4j.js";
import "./ssrf-MofQSeTB.js";
import "./store-DM25NjFE.js";
import { i as formatPortDiagnostics, n as inspectPortUsage, t as ensurePortAvailable } from "./ports-B-sNNAH_.js";
import { t as movePathToTrash } from "./trash-CkoTsduV.js";
import "./dock-BoYjClAF.js";
import "./accounts-CYoNNt2n.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-CJeHSIux.js";
import "./tool-images-D6c_0ySf.js";
import { a as normalizeElevatedLevel, c as normalizeUsageDisplay, d as supportsXHighThinking, l as normalizeVerboseLevel, n as formatXHighModelHint, o as normalizeReasoningLevel, s as normalizeThinkLevel, t as formatThinkingLevels } from "./thinking-BMF5Lj9k.js";
import "./models-config-QXP5sEUp.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-D0pmm6mE.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-CIekPqKj.js";
import "./manager-y6B5FtH_.js";
import "./gemini-auth-Btd_r0sl.js";
import "./sqlite-D5NWcoFL.js";
import "./retry-BqINXZ-d.js";
import { t as ToolInputError } from "./common-CqPpwLxe.js";
...
import { l as registerUnhandledRejectionHandler } from "./runner-CIcjU-JD.js";
import { n as loadModelCatalog } from "./model-catalog-d5K0907t.js";
...
import { C as resolvePairingPaths, E as writeJsonAtomic, O as getSkillsSnapshotVersion, S as pruneExpiredPending, T as readJsonFile, _ as requestNodePairing, b as generatePairingToken, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, k as registerSkillsChangeListener, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, w as createAsyncLock, x as verifyPairingToken, y as verifyNodeToken } from "./skill-commands-CwUsNtLP.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-DbV1rwga.js";
import "./pairing-store-CWbTPkUY.js";
import "./fetch-RhTQDQbf.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-Dsc0IrWL.js";
import "./nodes-screen-DcirdJP7.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-BR5wNTCV.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-BtvBsfKP.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-Mf7xI3KO.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-BCQzFuQi.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-CZ7KSohZ.js";
import { n as normalizePollInput } from "./polls-D9BrQxyf.js";
...
import { t as getChannelActivity } from "./channel-activity-DmCSK7Gk.js";
...
import { n as withProgress } from "./progress-Clpi3Ckj.js";
import "./replies-By_6vjNK.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-BEtFxTGS.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-Wi2a0F-c.js";
import "./prompt-style-B_yUCLn4.js";
import "./pairing-labels-3nsEq_HC.js";
import { i as onHeartbeatEvent, r as getLastHeartbeatEvent, t as resolveHeartbeatVisibility } from "./heartbeat-visibility-ChEo5Zvk.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-C6L51Z2a.js";
import { n as DEFAULT_GATEWAY_HTTP_TOOL_DENY } from "./dangerous-tools-B7yH-Zod.js";
import { n as inheritOptionFromParent } from "./command-options-WQ1wfC_v.js";
import { t as buildChannelUiCatalog } from "./catalog-DrXj_7vG.js";
import { t as WizardCancelledError } from "./prompts-BCG1qd2x.js";
import { t as resolveChannelDefaultAccountId } from "./helpers-D7F4NeUu.js";
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-C-zE_nz9.js";
...
import "./lifecycle-core-B1gvnBTv.js";
import "./systemd-hints-C2n6cQfN.js";
import { t as parsePort$1 } from "./parse-port-EcWC3aKG.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-BqahwtIW.js";
import "./diagnostics-CK4NIDhc.js";
import "./table-Bka4fasy.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-BdXjt1yM.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-utS9Wqeh.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-BJOX2U71.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-sdGLCcwL.js";
import { i as pickGatewaySelfPresence, r as getStatusSummary } from "./status-B2wE-vYz.js";
import { a as styleHealthChannelLine, c as setHeartbeatsEnabled, l as startHeartbeatRunner, n as getHealthSnapshot, s as runHeartbeatOnce, t as formatHealthChannelLines } from "./health-B-qxkTBH.js";
import { n as createDefaultDeps, r as createOutboundSendDeps$1, t as createOutboundSendDeps } from "./outbound-send-deps-roW8iOoy.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-D2eHIaCV.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-BxNV3xAX.js";
import { t as runOnboardingWizard } from "./onboarding-B-XiaxJ6.js";
import { a as shouldLogWs, i as logWs, n as parseMessageWithAttachments, o as summarizeAgentEventForWsLog, r as formatForLog, s as setGatewayWsLogStyle, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-C32q_RA2.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-DHHPV6Ib.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-BOvdjEBE.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-DK9xuL97.js";
...
import { t as installSkill } from "./skills-install-BB01uizR.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-C7BEi0VV.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-u0DxsyuQ.js";
import { n as forceFreePortAndWait } from "./ports-B-X-4hOo.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DQ9xAR-K.js");
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-BR5wNTCV.js").then((n) => n.a);
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-Mf7xI3KO.js").then((n) => n.t);
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-BTFZ_82k.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-CkuuwqYG.js").then((n) => n.n);
