...
import { B as theme, C as shortenHomePath, D as truncateUtf16Safe, H as getLogger, P as setVerbose, R as colorize, U as getResolvedLoggerSettings, V as getChildLogger, b as resolveUserPath, c as ensureDir, d as isPlainObject, r as clamp, t as CONFIG_DIR, z as isRich } from "./utils-CFnnyoTP.js";
...
import { $ as scheduleGatewaySigusr1Restart, A as listSessionsFromStore, An as resolveTtsApiKey, Bn as getActiveTaskCount, Bt as requestBodyErrorToText, C as readLatestAssistantReply, Cn as getAgentRunContext, D as canonicalizeSpawnedByForAgent, Dn as getTtsProvider, En as resolveUserTimezone, Et as requestHeartbeatNow, F as resolveSessionModelRef, Fn as setTtsEnabled, Gn as waitForActiveTasks, Gt as getHookType, H as resolveSessionDeliveryTarget, Hn as getTotalQueueSize, Ht as sleepWithAbort, In as setTtsProvider, J as consumeGatewaySigusr1RestartAuthorization, K as runWithModelFallback, Kn as CommandLane, Kt as isExternalHookSession, L as ensureOutboundSessionEntry, Ln as textToSpeech, M as loadSessionEntry, Mn as resolveTtsConfig, N as pruneLegacyStoreKeys, Nn as resolveTtsPrefsPath, Nt as loadProviderUsageSummary, On as isTtsEnabled, Ot as getPluginToolMeta, P as resolveGatewaySessionStoreTarget, Pn as resolveTtsProviderOrder, Q as markGatewaySigusr1RestartHandled, Qn as lookupContextTokens, R as resolveOutboundSessionRoute, Rn as OPENAI_TTS_MODELS, Rt as handleSlackHttpRequest, S as createOpenClawTools, Sn as emitAgentEvent, Tn as registerAgentRunContext, Tt as persistBrowserProxyFiles, Un as resetAllLanes, Ut as buildSafeExternalPrompt, V as resolveOutboundTarget, Vt as computeBackoff, W as resetDirectoryCache, Wn as setCommandLaneConcurrency, Wt as detectSuspiciousPatterns, X as emitGatewayRestart, Xt as buildHistoryContextFromEntries, Y as deferGatewayRestartUntilIdle, Z as isGatewaySigusr1RestartExternallyAllowed, Zn as stripHeartbeatToken, _ as waitForEmbeddedPiRunEnd, _n as initSubagentRegistry, _t as normalizeRequiredName, a as getCliSessionId, b as buildDefaultToolPolicyPipelineSteps, bn as runSubagentAnnounceFlow, bt as hasLegacyDeliveryHints, cr as DEFAULT_INPUT_IMAGE_MIMES, ct as writeRestartSentinel, d as normalizeSendPolicy, dr as extractFileContentFromSource, dt as normalizeCronJobPatch, er as applyModelOverrideToSessionEntry, et as setGatewaySigusr1RestartPolicy, f as resolveSendPolicy, fn as isAbortTrigger, fr as extractImageContentFromSource, ft as inferLegacyName, g as getActiveEmbeddedRunCount, gn as countActiveDescendantRuns, gr as resolveAgentTimeoutMs, gt as normalizePayloadToSystemText, h as abortEmbeddedPiRun, ht as normalizeOptionalText, i as resolveCronStyleNow, ir as isSystemEventContextChanged, it as formatRestartSentinelMessage, j as loadCombinedSessionStoreForGateway, jn as resolveTtsAutoMode, jt as normalizeGroupActivation, k as listAgentsForGateway, kn as isTtsProviderConfigured, kt as loadOpenClawPlugins, ln as formatZonedTimestamp, lr as DEFAULT_INPUT_MAX_REDIRECTS, lt as normalizeHttpWebhookUrl, m as runEmbeddedPiAgent, mr as resolveInputFileLimits, mt as normalizeOptionalSessionKey, n as BARE_SESSION_RESET_PROMPT, nn as createReplyDispatcher, nr as parseVerboseOverride, nt as consumeRestartSentinel, o as setCliSessionId, ot as summarizeRestartSentinel, p as clearSessionQueues, pn as stopSubagentsForRequester, pr as normalizeMimeList, pt as normalizeOptionalAgentId, qn as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, rn as getTotalPendingReplies, rr as enqueueSystemEvent, rt as formatDoctorNonInteractiveHint, s as runCliAgent, sr as DEFAULT_INPUT_IMAGE_MAX_BYTES, tn as dispatchInboundMessage, tr as applyVerboseOverride, tt as setPreRestartDeferralCheck, ur as DEFAULT_INPUT_TIMEOUT_MS, ut as normalizeCronJobCreate, vn as listDescendantRunsForRequester, vt as migrateLegacyCronPayload, w as resolveAnnounceTargetFromKey, wn as onAgentEvent, wt as applyBrowserProxyPaths, xn as clearAgentRunContext, xt as stripLegacyDeliveryFields, y as applyToolPolicyPipeline, yt as buildDeliveryFromLegacyPayload, zn as OPENAI_TTS_VOICES, zt as readJsonBodyWithLimit } from "./reply-oSe13ewW.js";
import { b as isSubagentSessionKey, d as resolveAgentIdFromSessionKey, h as toAgentStoreSessionKey, i as buildAgentMainSessionKey, l as normalizeAgentId, m as toAgentRequestSessionKey, n as DEFAULT_AGENT_ID, s as classifySessionKeyShape, t as DEFAULT_ACCOUNT_ID, u as normalizeMainKey, v as isCronRunSessionKey, x as parseAgentSessionKey } from "./session-key-CZ6OwgSB.js";
import { r as matchesSkillFilter, t as resolveOpenClawPackageRoot } from "./openclaw-root-BWMsT33G.js";
import { C as createInternalHookEvent, S as clearInternalHooks, T as triggerInternalHook, d as getActivePluginRegistry, m as createEmptyPluginRegistry, r as DEFAULT_CHAT_CHANNEL, t as CHANNEL_IDS, w as registerInternalHook } from "./registry-D74-I5q-.js";
import { a as setConsoleSubsystemFilter, f as defaultRuntime, n as runtimeForLogger, o as setConsoleTimestampPrefix, t as createSubsystemLogger } from "./subsystem-oVAQxyhr.js";
import { i as logDebug, n as runExec, s as logWarn, t as runCommandWithTimeout } from "./exec-i2CMvUxK.js";
import { D as resolveWorkspaceTemplateDir, E as resolveDefaultAgentWorkspaceDir, S as ensureAgentWorkspace, _ as DEFAULT_MEMORY_ALT_FILENAME, b as DEFAULT_TOOLS_FILENAME, c as resolveDefaultAgentId, f as DEFAULT_AGENTS_FILENAME, g as DEFAULT_IDENTITY_FILENAME, h as DEFAULT_HEARTBEAT_FILENAME, i as resolveAgentModelFallbacksOverride, m as DEFAULT_BOOTSTRAP_FILENAME, n as resolveAgentConfig, o as resolveAgentSkillsFilter, r as resolveAgentDir, s as resolveAgentWorkspaceDir, t as listAgentIds, u as resolveSessionAgentId, v as DEFAULT_MEMORY_FILENAME, w as isWorkspaceOnboardingCompleted, x as DEFAULT_USER_FILENAME, y as DEFAULT_SOUL_FILENAME } from "./agent-scope-CrP-i2MF.js";
import { Ft as isPidAlive, Ht as DEFAULT_MODEL, Lt as normalizeSecretInput, Ut as DEFAULT_PROVIDER, Vt as DEFAULT_CONTEXT_TOKENS, _ as resolveThinkingDefault, a as getModelRefStatus, d as resolveAllowedModelRef, h as resolveHooksGmailModel, m as resolveDefaultModelForAgent, o as isCliProvider, p as resolveConfiguredModelRef } from "./model-selection-CqXyRThV.js";
import "./github-copilot-token-D2zp6kMZ.js";
import { t as formatCliCommand } from "./command-format-DEKzLnLg.js";
import "./boolean-BsqeuxE6.js";
import { n as logAcceptedEnvOption, t as isTruthyEnvValue } from "./env-BV0iTNjd.js";
import { D as applyMergePatch, F as resolveAgentMaxConcurrent, I as resolveSubagentMaxConcurrent, L as VERSION, O as applyLegacyMigrations, _ as parseDurationMs, a as parseConfigJson5, c as resolveConfigSnapshotHash, d as OpenClawSchema, g as sensitive, i as loadConfig, l as writeConfigFile, n as migrateLegacyConfig, o as readConfigFileSnapshot, r as createConfigIO, s as readConfigFileSnapshotForWrite, u as validateConfigObjectWithPlugins } from "./config-F0Q6PyfW.js";
import { s as isTestDefaultMemorySlotDisabled } from "./manifest-registry-DoaWeDHN.js";
import { l as registerUnhandledRejectionHandler } from "./runner-CtkNTG0l.js";
...
import { g as collectExplicitAllowlist, x as resolveToolProfilePolicy, y as mergeAlsoAllowPolicy } from "./sandbox-DEFCexaq.js";
import "./chrome-DuvmuAVy.js";
import { i as enableTailscaleServe, n as disableTailscaleServe, o as getTailnetHostname, r as enableTailscaleFunnel, t as disableTailscaleFunnel } from "./tailscale-B2RP0O39.js";
import { t as safeEqualSecret } from "./secret-equal-7UEI0ktk.js";
import { n as pickPrimaryTailnetIPv4, r as pickPrimaryTailnetIPv6 } from "./tailnet-Cbhv6uXB.js";
import { a as isTrustedProxyAddress, d as resolveGatewayClientIp, f as resolveGatewayListenHosts, i as isPrivateOrLoopbackAddress, l as pickPrimaryLanIPv4, n as isLoopbackAddress, p as resolveHostName, r as isLoopbackHost, s as normalizeHostHeader, t as rawDataToString, u as resolveGatewayBindHost } from "./ws-CCvxoPJE.js";
import { a as AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN, i as resolveGatewayAuth, n as authorizeGatewayConnect, o as AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET, r as isLocalDirectRequest, s as createAuthRateLimiter, t as assertGatewayAuthConfigured } from "./auth-Kz-t4hed.js";
import "./server-context-lJCfpccv.js";
import { d as hasBinary } from "./frontmatter-DrdSsH4-.js";
import { i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-BCkGHN5q.js";
import "./routes-DJNVqbMy.js";
import "./redact-CjJyQlVU.js";
import { a as isErrno, n as formatErrorMessage } from "./errors-CdJjJ1Jq.js";
import "./paths-CWc9mjAN.js";
import "./ssrf-Bhv0qRd-.js";
import { o as detectMime } from "./image-ops-ib1_UDIa.js";
import "./store-CHQKN-y-.js";
import { a as inspectPortUsage, r as ensurePortAvailable, s as formatPortDiagnostics } from "./ports-Dru7vIR6.js";
import { t as movePathToTrash } from "./trash-DhlImRqi.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-B11syIWY.js";
import { B as resolveAgentMainSessionKey, C as readSessionPreviewItemsFromTranscript, E as stripEnvelopeFromMessages, G as snapshotSessionOrigin, H as resolveMainSessionKey, M as evaluateSessionFreshness, O as cleanStaleLockFiles, P as resolveSessionResetPolicy, S as readSessionMessages, T as resolveSessionTranscriptCandidates, U as resolveMainSessionKeyFromConfig, V as resolveExplicitAgentSessionKey, _ as normalizeSessionDeliveryFields, b as archiveSessionTranscripts, h as mergeDeliveryContext, i as loadSessionStore, l as updateSessionStore, p as deliveryContextFromSession, t as extractDeliveryInfo, x as capArrayByJsonBytes, y as archiveFileOnDisk, z as canonicalizeMainSessionAlias } from "./sessions-CHz-yoEe.js";
...
import { t as buildChannelAccountBindings } from "./bindings-CssSUqXx.js";
import "./logging-D3KTM1pH.js";
import "./send-QSP-aBY1.js";
import { n as listChannelPlugins, r as normalizeChannelId, t as getChannelPlugin } from "./plugins-MECKrdj4.js";
import "./send-CAzpVpjf.js";
import { c as resolveStorePath, i as resolveSessionTranscriptPath, n as resolveSessionFilePath, r as resolveSessionFilePathOptions, s as resolveSessionTranscriptsDirForAgent } from "./paths-gjLMn4eA.js";
...
import { n as loadModelCatalog } from "./model-catalog-B0-YH7XM.js";
import { n as SILENT_REPLY_TOKEN, r as isSilentReplyText } from "./tokens-sV_zGSb7.js";
import { n as createBrowserRouteDispatcher, r as getMachineDisplayName } from "./with-timeout-CrJpIPCq.js";
import { C as getGlobalHookRunner, T as runGlobalGatewayStopSafely, o as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-B1N4QPj7.js";
import { d as startDiagnosticHeartbeat, f as stopDiagnosticHeartbeat, m as isDiagnosticsEnabled } from "./diagnostic-B81gAc3S.js";
import "./diagnostic-session-state-d6bm-JJd.js";
import "./send-LkrQUW5e.js";
import "./model-Br9l2OSe.js";
import { a as resolveAgentIdentity, t as createReplyPrefixOptions } from "./reply-prefix-Dk5Tb9So.js";
import { i as resolveMemoryBackendConfig, r as getMemorySearchManager } from "./memory-cli-BdWf9WeK.js";
import "./manager-JQDuyylL.js";
import "./sqlite-DWNRhtfU.js";
import "./retry-CsJdgSl0.js";
import { t as ToolInputError } from "./common-CmR0t2Y-.js";
...
import { t as formatHelpExamples } from "./help-format-BwCqDl6O.js";
import { n as withProgress } from "./progress-By07Lltm.js";
import "./resolve-route-CMiOzrE9.js";
import "./replies-CugbfuWa.js";
import { C as resolvePairingPaths, E as writeJsonAtomic, O as getSkillsSnapshotVersion, S as pruneExpiredPending, T as readJsonFile, _ as requestNodePairing, b as generatePairingToken, c as recordRemoteNodeInfo, d as removeRemoteNodeInfo, f as setSkillsRemoteRegistry, g as renamePairedNode, h as rejectNodePairing, k as registerSkillsChangeListener, l as refreshRemoteBinsForConnectedNodes, m as listNodePairing, o as getRemoteSkillEligibility, p as approveNodePairing, s as primeRemoteSkillsCache, u as refreshRemoteNodeBins, v as updatePairedNodeMetadata, w as createAsyncLock, x as verifyPairingToken, y as verifyNodeToken } from "./skill-commands-CLVv4uiZ.js";
import { t as listAgentWorkspaceDirs } from "./workspace-dirs-CcREWmBd.js";
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy } from "./pi-tools.policy-dtMy2j5O.js";
import "./send-B3ztcjJe.js";
import { C as normalizeControlUiBasePath, S as buildControlUiAvatarUrl, c as handleReset, w as resolveAssistantAvatarUrl, x as CONTROL_UI_AVATAR_PREFIX } from "./onboard-helpers-BClizJPp.js";
import "./prompt-style-K932lPCL.js";
import "./outbound-attachment-CO0tbY9_.js";
import "./pairing-labels-DvVTrpil.js";
import { c as hasNonzeroUsage, i as loadSessionUsageTimeSeries, n as loadCostUsageSummary, r as loadSessionCostSummary, s as deriveSessionTotalTokens, t as discoverAllSessions } from "./session-cost-usage-C72DlXmh.js";
import { n as formatTokenCount, r as formatUsd } from "./usage-format-DCNGbrIa.js";
import { a as mergeExecApprovalsSocketDefaults, c as readExecApprovalsSnapshot, p as saveExecApprovals, r as ensureExecApprovals, s as normalizeExecApprovals, t as DEFAULT_EXEC_APPROVAL_TIMEOUT_MS } from "./exec-approvals-30NFx3JN.js";
import "./nodes-screen-BVo2a8We.js";
import { n as createBrowserControlContext, r as startBrowserControlServiceFromConfig } from "./control-service-DjL3VC7s.js";
import { i as parseAbsoluteTimeMs, n as resolveCronStaggerMs, r as resolveDefaultCronStaggerMs, t as normalizeCronStaggerMs } from "./stagger-xzJwPnK6.js";
import { n as resolveMessageChannelSelection } from "./channel-selection-z5hlR27m.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-xCpK9lRd.js";
import { t as ensureOpenClawCliOnPath } from "./path-env-BN27ynJ2.js";
import "./runtime-guard-DLhZHmF6.js";
import { t as forceFreePortAndWait } from "./ports-BAxggYjz.js";
import { t as buildChannelUiCatalog } from "./catalog-DdTNZaU_.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-BpJ9eTt-.js";
...
import { t as applyPluginAutoEnable } from "./plugin-auto-enable-DGcbyCUN.js";
...
import "./channels-status-issues-D2Dzn3Yl.js";
import "./daemon-runtime-BBz9R8ay.js";
import "./systemd-DRtbohgw.js";
import "./service-UaLMhkKk.js";
import "./lifecycle-core-D6QQfKSp.js";
import "./systemd-hints-DMRp-4Mk.js";
import { t as parsePort$1 } from "./parse-port-QkaTJ4ru.js";
import { n as addGatewayServiceCommands } from "./daemon-cli-DNL8o42C.js";
import "./diagnostics-D-UkgCMk.js";
import "./table-Dlw499e9.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-B9AOEEa-.js";
import { i as toOptionString, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-LLJaRKEt.js";
import { c as probeGateway, o as isNodeCommandAllowed, s as resolveNodeCommandAllowlist } from "./audit-B0wKmtYn.js";
import { t as discoverGatewayBeacons } from "./bonjour-discovery-DrxJOeZq.js";
import { n as getStatusSummary, r as pickGatewaySelfPresence } from "./status-BUeLATqH.js";
import { c as startHeartbeatRunner, i as styleHealthChannelLine, n as getHealthSnapshot, o as runHeartbeatOnce, s as setHeartbeatsEnabled, t as formatHealthChannelLines } from "./health-D6v69hUF.js";
import { a as resolveControlUiRootSync, i as resolveControlUiRootOverrideSync, t as ensureControlUiAssetsBuilt } from "./control-ui-assets-B5HlHt1E.js";
import { a as resolveNpmChannelTag, c as DEFAULT_PACKAGE_CHANNEL, m as normalizeUpdateChannel, n as compareSemverStrings, t as checkUpdateStatus } from "./update-check-CpaYmQ_x.js";
import { t as runOnboardingWizard } from "./onboarding-B7IbiVQq.js";
import { a as shouldLogWs, i as logWs, n as parseMessageWithAttachments, o as summarizeAgentEventForWsLog, r as formatForLog, s as setGatewayWsLogStyle, t as normalizeRpcAttachmentsToChatAttachments } from "./attachment-normalize-C-wZdgz4.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-B_oVG2M1.js";
import { t as createOutboundSendDeps$1 } from "./outbound-send-deps-BPqlry-X.js";
import { a as loadAgentIdentity, c as loadAgentIdentityFromWorkspace, i as listAgentEntries, o as pruneAgentConfig, r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-B4khSHdO.js";
import { i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-Bkbt0izI.js";
import "./node-service-Bzrias-S.js";
import "./status.update-Ct2xRMBF.js";
import { n as validateSystemRunCommandConsistency, t as formatExecCommand } from "./system-run-command-B0MK4ZUg.js";
import { t as installSkill } from "./skills-install-Bkq2uwlG.js";
import { n as runGatewayUpdate, t as resolveAgentSessionDirs } from "./session-dirs-qhDpvTQF.js";
import { i as shouldIncludeHook, r as resolveHookConfig, t as loadWorkspaceHookEntries } from "./workspace-CbKyWVpA.js";
...
function shouldSkipDiscordForwarding(target) {
	return (normalizeMessageChannel(target.channel) ?? target.channel) === "discord";
}
...
async function runCronIsolatedAgentTurn(params) {
	...
	if (deliveryRequested && !skipHeartbeatDelivery && !skipMessagingToolDelivery) {
		...
		if (deliveryPayloadHasStructuredContent) try {
			...
			if (payloadsForDelivery.length > 0) delivered = (await deliverOutboundPayloads({
				cfg: cfgWithAgentDefaults,
				channel: resolvedDelivery.channel,
				to: resolvedDelivery.to,
				accountId: resolvedDelivery.accountId,
...
async function onTimer(state) {
	...
	try {
		...
		for (const { id, job } of dueJobs) {
			...
			const jobTimeoutMs = configuredTimeoutMs !== void 0 ? configuredTimeoutMs <= 0 ? void 0 : configuredTimeoutMs : DEFAULT_JOB_TIMEOUT_MS;
			try {
				const result = typeof jobTimeoutMs === "number" ? await (async () => {
					let timeoutId;
					try {
						return await Promise.race([executeJobCore(state, job), new Promise((_, reject) => {
...
const FIELD_HELP = {
	...
	"memory.qmd.scope": "Session/channel scope for QMD recall (same syntax as session.sendPolicy; default: direct-only). Use match.rawKeyPrefix to match full agent-prefixed session keys.",
...
async function verifyDeviceToken(params) {
	return await withLock(async () => {
		...
		if (!scopesAllow(normalizeDeviceAuthScopes(params.scopes), entry.scopes)) return {
			ok: false,
...
function getCmdText(params) {
	...
	if (Array.isArray(params.command)) {
		...
		if (parts.length > 0) return formatExecCommand(parts);
	}
	return "";
}
...
function sanitizeSystemRunParamsForForwarding(opts) {
	...
	if (raw) {
		if (!Array.isArray(p.command) || argv.length === 0) return {
			ok: false,
	...
	if (!approvalMatchesRequest(p, snapshot)) return {
		ok: false,
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-DUSLNRlN.js");
...
const sendHandlers = {
	send: async ({ params, respond, context }) => {
		...
		if (channelInput && !normalizedChannel) {
			if (channelInput.trim().toLowerCase() === "webchat") {
				respond(false, void 0, errorShape(ErrorCodes.INVALID_REQUEST, "unsupported channel: webchat (internal-only). Use `chat.send` for WebChat UI messages or choose a deliverable channel."));
				return;
			}
...
const usageHandlers = {
	...
	"sessions.usage.logs": async ({ respond, params }) => {
		...
		if (!resolved) return;
		const { config, entry, agentId, sessionId, sessionFile } = resolved;
		const { loadSessionLogs } = await import("./session-cost-usage-C72DlXmh.js").then((n) => n.a);
...
function resolveContainedPath(baseDir, target, label) {
	...
	if (relative === ".." || relative.startsWith(`..${path.sep}`) || path.isAbsolute(relative)) throw new Error(`${label} module path must be within ${base}: ${target}`);
	return resolved;
}
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-DjL3VC7s.js").then((n) => n.t);
...
async function resolveGatewayRuntimeConfig(params) {
	...
	if (authMode === "trusted-proxy") {
		if (isLoopbackHost(bindHost)) throw new Error("gateway auth mode=trusted-proxy makes no sense with bind=loopback; use bind=lan or bind=custom with gateway.trustedProxies configured");
...
async function startGatewayServer(port = 18789, opts = {}) {
	...
	if (!minimalTestGateway) (async () => {
		const { recoverPendingDeliveries } = await import("./delivery-queue-fx8E3HqU.js").then((n) => n.n);
		const { deliverOutboundPayloads } = await import("./deliver-B1N4QPj7.js").then((n) => n.n);
