...
import { i as buildAgentMainSessionKey, l as normalizeAgentId, u as normalizeMainKey, x as parseAgentSessionKey } from "./session-key-BGiG_JcT.js";
...
import { Dt as PROTOCOL_VERSION, t as GatewayClient } from "./client-B0TEt50q.js";
import { a as resolveExplicitGatewayAuth, r as ensureExplicitGatewayAuth, t as buildGatewayConnectionDetails } from "./call-DETrZKco.js";
import { f as GATEWAY_CLIENT_CAPS, h as GATEWAY_CLIENT_NAMES, m as GATEWAY_CLIENT_MODES } from "./message-channel-B9mgJ1nn.js";
import { _ as formatRawAssistantErrorForUi } from "./pi-embedded-helpers-BKS_5Gh6.js";
import { c as normalizeUsageDisplay, r as listThinkingLevelLabels, t as formatThinkingLevels, u as resolveResponseUsageMode } from "./thinking-BMF5Lj9k.js";
import { a as listChatCommandsForConfig, i as listChatCommands } from "./commands-registry-D7DNJSuh.js";
import { n as resolveToolDisplay, t as formatToolDetail } from "./tool-display-VGkGf5S9.js";
import { n as formatTimeAgo, t as formatRelativeTimestamp } from "./format-relative-TU8IDQdE.js";
import { n as formatTokenCount } from "./usage-format-BtvBsfKP.js";
...
function sanitizeRenderableText(text) {
	...
	return LONG_TOKEN_TEST_RE.test(redacted) ? redacted.replace(LONG_TOKEN_RE, normalizeLongTokenForDisplay) : redacted;
}
