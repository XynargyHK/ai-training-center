import { S as resolveThreadParentSessionKey, d as resolveAgentIdFromSessionKey } from "./session-key-CZ6OwgSB.js";
import { n as resolveAgentConfig } from "./agent-scope-CrP-i2MF.js";
import { C as compileGlobPatterns, b as normalizeToolName, v as expandToolGroups, w as matchesAnyGlobPattern } from "./sandbox-DEFCexaq.js";
import { l as normalizeMessageChannel } from "./message-channel-B11syIWY.js";
import { o as resolveChannelGroupToolsPolicy, t as getChannelDock } from "./dock-Bdl338Dx.js";
...
function resolveSubagentToolPolicy(cfg, depth) {
	...
	const deny = [...resolveSubagentDenyList(typeof depth === "number" && depth >= 0 ? depth : 1, maxSpawnDepth), ...Array.isArray(configured?.deny) ? configured.deny : []];
	return {
...
//#endregion
export { resolveSubagentToolPolicy as a, resolveNativeCommandsEnabled as c, resolveGroupToolPolicy as i, resolveNativeSkillsEnabled as l, isToolAllowedByPolicies as n, pickSandboxToolPolicy as o, resolveEffectiveToolPolicy as r, isNativeCommandsExplicitlyDisabled as s, filterToolsByPolicy as t };