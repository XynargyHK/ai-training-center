...
import { L as safeParseJson, W as danger, q as logVerbose } from "./registry-BVeYESaO.js";
import { t as createSubsystemLogger } from "./subsystem-D5Ceunbp.js";
import { o as resolveTelegramAccount } from "./normalize-CBJSRI13.js";
import { t as isTruthyEnvValue } from "./env-Dxd9mJn7.js";
import { n as listChannelPlugins, t as getChannelPlugin } from "./plugins-DSZtXzTw.js";
import { C as mediaKindFromMime, b as normalizeMimeType, h as getFileExtension, v as isGifMedia } from "./image-ops-CjLvw22Q.js";
import { b as withFileLock$1 } from "./model-auth-XLztKWJW.js";
import { n as loadConfig } from "./config-BNjb0X52.js";
import { t as redactSensitiveText } from "./redact-9hYpOXID.js";
import { n as formatErrorMessage, r as formatUncaughtError, t as extractErrorCode } from "./errors-pj0CRkCB.js";
import { n as resolveMarkdownTableMode } from "./markdown-tables-DjjJavbM.js";
import { a as loadWebMedia, n as markdownToIR, t as chunkMarkdownIR } from "./ir-BwD9kRy7.js";
...
import { i as createTelegramRetryRunner, n as recordChannelActivity } from "./channel-activity-C1Xw_p45.js";
...
async function withTelegramHtmlParseFallback(params) {
	try {
		...
		if (params.verbose) console.warn(`telegram ${params.label} failed with HTML parse error, retrying as plain text: ${formatErrorMessage(err)}`);
...
async function withTelegramThreadFallback(params, label, verbose, attempt) {
	try {
		...
		if (verbose) console.warn(`telegram ${label} failed with message_thread_id, retrying without thread: ${formatErrorMessage(err)}`);
...
//#endregion
export { resolveTelegramTargetChatType as $, extractTelegramLocation as A, isSenderAllowed as B, buildTelegramGroupFrom as C, buildTypingThreadParams as D, buildTelegramThreadParams as E, resolveTelegramMediaPlaceholder as F, addChannelAllowFromStoreEntry as G, resolveSenderAllowMatch as H, resolveTelegramReplyId as I, upsertChannelPairingRequest as J, readChannelAllowFromStore as K, resolveTelegramStreamMode as L, normalizeForwardedContext as M, resolveTelegramForumThreadId as N, describeReplyTarget as O, resolveTelegramGroupAllowFromContext as P, parseTelegramTarget as Q, resolveTelegramThreadSpec as R, buildSenderName as S, buildTelegramParentPeer as T, formatLocationText as U, normalizeAllowFromWithStore as V, toLocationContext as W, listPairingChannels as X, getPairingAdapter as Y, isVoiceCompatibleAudio as Z, resolveTelegramFetch as _, reactMessageTelegram as a, buildGroupLabel as b, sendStickerTelegram as c, wasSentByBot as d, isRecoverableTelegramNetworkError as f, wrapFileReferencesInHtml as g, renderTelegramHtmlText as h, editMessageTelegram as i, hasBotMention as j, expandTextLinks as k, send_exports as l, markdownToTelegramHtml as m, createForumTopicTelegram as n, sendMessageTelegram as o, markdownToTelegramChunks as p, removeChannelAllowFromStoreEntry as q, deleteMessageTelegram as r, sendPollTelegram as s, buildInlineKeyboard as t, resolveTelegramVoiceSend as u, splitTelegramCaption as v, buildTelegramGroupPeerId as w, buildSenderLabel as x, withTelegramApiErrorLogging as y, firstDefined as z };