...
import { L as normalizeProviderId, Z as normalizeGoogleModelId, _t as requireApiKey, vt as resolveApiKeyForProvider } from "./auth-profiles-Cn5oo5Dj.js";
import { n as runExec } from "./exec-CBKBIMpA.js";
import { t as normalizeChatType } from "./chat-type-DedJJ5qX.js";
import { c as getFileExtension, f as kindFromMime, o as detectMime, u as isAudioFileName } from "./image-ops-DOCAfk8A.js";
import { r as formatUncaughtError, t as extractErrorCode } from "./errors-BtWNsPzQ.js";
...
import { n as fetchWithTimeout } from "./fetch-timeout-DUo3Ogxz.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-CFsdMv4v.js";
import { n as fetchRemoteMedia, t as MediaFetchError } from "./fetch-zMf2in8v.js";
import { t as describeImageWithModel } from "./image-ecroz6qY.js";
import { n as loadModelCatalog, r as modelSupportsVision, t as findModelInCatalog } from "./model-catalog-d5K0907t.js";
...
async function runProviderEntry(params) {
	...
	if (capability === "audio") {
		...
		const apiKeys = collectProviderApiKeysForExecution({
			provider: providerId,
			primaryApiKey: requireApiKey(await resolveApiKeyForProvider({
				provider: providerId,
				cfg,
...
//#endregion
export { runCapability as a, installUnhandledRejectionHandler as c, resolveTimeoutMs as d, normalizeMediaUnderstandingChatType as f, applyTemplate as h, resolveAutoImageModel as i, registerUnhandledRejectionHandler as l, CLI_OUTPUT_MAX_BUFFER as m, createMediaAttachmentCache as n, isAudioAttachment as o, resolveMediaUnderstandingScope as p, normalizeMediaAttachments as r, resolveAttachmentKind as s, buildProviderRegistry as t, resolveConcurrency as u };