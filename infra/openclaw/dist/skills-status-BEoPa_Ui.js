...
import { t as evaluateEntryMetadataRequirements } from "./entry-status-B7h1JAwh.js";
import { d as hasBinary } from "./frontmatter-DRl3Sa-X.js";
import { _ as isConfigPathTruthy, c as resolveBundledSkillsDir, g as isBundledSkillAllowed, i as loadWorkspaceSkillEntries, t as resolveSkillsInstallPreferences, v as resolveBundledAllowlist, y as resolveSkillConfig } from "./skills-BDAyXEfy.js";
...
function buildSkillStatus(entry, config, prefs, eligibility, bundledNames) {
	...
	const { emoji, homepage, required, missing, requirementsSatisfied, configChecks } = evaluateEntryMetadataRequirements({
		always,
