...
import { Dt as theme, Et as isRich, Tt as colorize, Yt as resolveStateDir, _ as defaultRuntime, lt as shortenHomeInString, o as createSubsystemLogger, st as resolveUserPath, ut as shortenHomePath, xt as setVerbose } from "./entry.js";
...
import { t as splitShellArgs } from "./shell-argv-CotdnqZ6.js";
import { d as listMemoryFiles, f as normalizeExtraMemoryPaths } from "./sqlite-D5NWcoFL.js";
import { t as formatDocsLink } from "./links-rnbUL9h5.js";
import { r as withManager } from "./cli-utils-f9j-_1VT.js";
import { t as formatHelpExamples } from "./help-format-5GFCgEVf.js";
import { n as withProgress, r as withProgressTotals } from "./progress-Clpi3Ckj.js";
...
async function getMemorySearchManager(params) {
	...
	if (resolved.backend === "qmd" && resolved.qmd) {
		...
		try {
			const { QmdMemoryManager } = await import("./qmd-manager-2ccfyheP.js");
			...
			if (primary) {
				...
				const wrapper = new FallbackMemoryManager({
					...
					fallbackFactory: async () => {
						const { MemoryIndexManager } = await import("./manager-y6B5FtH_.js").then((n) => n.t);
