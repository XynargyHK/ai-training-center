            ...
            if lang:
                ...
                if lang_str != self._current_lang:
                    ...
                    if new_voice != old_voice:
                        ...
                        logger.info(f"Auto TTS voice swap: {old_voice} → {new_voice} (lang: {lang_str})")
...
async def run_pipeline(
    ...
    # --- STT: Azure auto-detect (returns TranscriptionFrame.language for AutoTTSVoiceSwapper) ---
...
- After searching, summarize the key finding naturally. Don't read out URLs."""
    ...
    # --- Auto TTS Voice Swapper (reads detected language from Azure auto-detect STT) ---
