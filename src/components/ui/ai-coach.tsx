...
const AICoach = ({ className = '', businessUnit = 'skincoach', initialOpen = false, selectedStaff = null }: AICoachProps) => {
  ...
  return (
    <div className={`fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 ${className}`}>
      <div className="bg-white/95 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl w-[calc(100vw-2rem)] h-[calc(100vh-6rem)] md:w-[500px] md:h-[600px] max-w-[500px] flex flex-col">
        {/* Header */}
