...
const LANG = 'yue'  // LOCKED: Cantonese prototype

export default function Voice5922922Page() {
  ...
  async function makePhoneCall() {
    ...
    try {
      const res = await fetch(`${PIPECAT_URL}/dialout5922922`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div style={{ maxWidth: 600, margin: '40px auto', padding: 20, fontFamily: 'system-ui' }}>
      <h1>Voice AI 5922922 — Cantonese (yue)</h1>
      <p style={{ color: '#666', fontSize: 14 }}>
        Prototype: commit 5922922 · LiveKit · Deepgram multi STT · Gemini Flash · Azure WanLung TTS
      </p>
