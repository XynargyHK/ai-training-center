...
const LANG = 'en'  // LOCKED: Azure auto-detect STT + AutoTTSVoiceSwapper

export default function Voice5922922AutoswapPage() {
  ...
  async function makePhoneCall() {
    ...
    try {
      const res = await fetch(`${PIPECAT_URL}/dialout5922922autoswap`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  return (
    <div style={{ maxWidth: 600, margin: '40px auto', padding: 20, fontFamily: 'system-ui' }}>
      <h1>Voice AI 5922922 AutoSwap — Auto Voice Switch</h1>
      <p style={{ color: '#666', fontSize: 14 }}>
        Prototype: commit 5922922 + AutoTTSVoiceSwapper · LiveKit · Azure auto-detect STT · Gemini Flash · TTS auto-swaps voice per language
      </p>
