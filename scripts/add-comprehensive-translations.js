/**
 * Script to add comprehensive translations to all languages
 * This adds Chinese (Simplified), Chinese (Traditional), and Vietnamese translations
 */
...
// Simplified Chinese translations to add after the existing zh-CN section
const zhCNAdditions = `
    add: '添加',
    edit: '编辑',
    delete: '删除',
...
console.log('Adding Simplified Chinese translations...');
// Find the zh-CN section and insert additional translations before the closing brace
content = content.replace(
  /('zh-CN': \{[\s\S]*?booking: '预约',)/,
  `$1\n${zhCNAdditions}`
);
