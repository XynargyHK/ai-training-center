-- ============================================================================
-- APPOINTMENT EDIT/CANCEL WORKFLOW TABLES
-- Handles approval workflow for appointment modifications
-- Flow: Staff Request → Manager Approval → Client Confirmation
-- ============================================================================
...
-- Tracks staff requests to edit or cancel appointments
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS appointment_change_requests (
  ...
  manager_approved_by TEXT, -- Manager email/identifier
  manager_notes TEXT,

  -- Client confirmation
  client_confirmed_at TIMESTAMPTZ,
  client_response TEXT, -- Client's response/notes
...
-- Audit log of all changes to appointments
-- ============================================================================
